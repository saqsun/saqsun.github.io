...
},{"../states/start-game-state-command":104,"@armathai/lego":281}],2:[function(require,module,exports){
'use strict';
...
var _joystickModelGuard = require('../../guards/ad/joystick-model-guard');

var _persistentCtaModelGuard = require('../../guards/ad/persistent-cta-model-guard');

var _playableIndicatorGuard = require('../../guards/ad/playable-indicator-guard');

var _powerUpModelGuard = require('../../guards/ad/power-up-model-guard');

var _tutorialModelGuard = require('../../guards/ad/tutorial-model-guard');

var _timerModelGuard = require('../../guards/timer/timer-model-guard');
...
var _destroyIndicatorModelCommand = require('../indicator/destroy-indicator-model-command');

var _initializeModelsCommand = require('../initialize-models-command');

var _shutdownModelsCommand = require('../shutdown-models-command');

var _resetPowerUpCommand = require('../snake/reset-power-up-command');
...
var _destroyJoystickModelCommand = require('./joystick/destroy-joystick-model-command');

var _destroyPersistentCtaModelCommand = require('./pcta/destroy-persistent-cta-model-command');

var _destroyPowerUpModelCommand = require('./power_up/destroy-power-up-model-command');

var _setAdStatusCommand = require('./set-ad-status-command');

var _destroyTimerModelCommand = require('./timer/destroy-timer-model-command');
...
function adStatusUpdateCommand(status) {
  switch (status) {
    case _constants.AdStatus.Game:
      _lego.lego.command
      //
      .execute(_mapPlayableCommandsCommand.mapPlayableCommandsCommand, _initializeModelsCommand.initializeModelsCommand);
      break;

    case _constants.AdStatus.Restart:
      _lego.lego.command
      //
      .execute(_restartGameStateCommand.restartGameStateCommand);
      break;

    case _constants.AdStatus.PreCta:
      _lego.lego.command
      //
      .payload(_store.store.game.boardModel.playerSnake.uuid).execute(_resetPowerUpCommand.resetPowerUpCommand).guard(_tutorialModelGuard.tutorialModelGuard).execute(_setTutorialSkipCommand.setTutorialSkipCommand).execute(_unmapPlayableCommandsCommand.unmapPlayableCommandsCommand).guard(_timerModelGuard.timerModelGuard).execute(_stopTimerCommand.stopTimerCommand, _destroyTimerModelCommand.destroyTimerModelCommand).guard(_joystickModelGuard.joystickModelGuard).execute(_destroyJoystickModelCommand.destroyJoystickModelCommand).guard(_powerUpModelGuard.powerUpModelGuard).execute(_destroyPowerUpModelCommand.destroyPowerUpModelCommand).guard(_hintModelGuard.hintModelGuard).execute(_destroyHintModelCommand.destroyHintModelCommand).guard(_playableIndicatorGuard.playableIndicatorGuard).execute(_destroyIndicatorModelCommand.destroyIndicatorModelCommand);
      break;

    case _constants.AdStatus.Cta:
      _lego.lego.command
      //
      .guard(_persistentCtaModelGuard.persistentCtaModelGuard).execute(_destroyPersistentCtaModelCommand.destroyPersistentCtaModelCommand);
      break;
...
},{"../../constants":146,"../../guards/ad/hint-model-guard":159,"../../guards/ad/joystick-model-guard":162,"../../guards/ad/persistent-cta-model-guard":166,"../../guards/ad/playable-indicator-guard":168,"../../guards/ad/power-up-model-guard":171,"../../guards/ad/tutorial-model-guard":176,"../../guards/timer/timer-model-guard":189,"../../models/store":215,"../game/map-playable-commands-command":71,"../game/unmap-playable-commands-command":73,"../indicator/destroy-indicator-model-command":74,"../initialize-models-command":77,"../shutdown-models-command":88,"../snake/reset-power-up-command":95,"../states/restart-game-state-command":103,"./hint/destroy-hint-model-command":12,"./joystick/destroy-joystick-model-command":19,"./pcta/destroy-persistent-cta-model-command":26,"./power_up/destroy-power-up-model-command":28,"./set-ad-status-command":36,"./timer/destroy-timer-model-command":41,"./timer/stop-timer-command":44,"./tutorial/set-tutorial-skip-command":56,"@armathai/lego":281}],3:[function(require,module,exports){
'use strict';
...
},{"../../constants":146,"../game-init-command":65,"../game-shut-down-command":66,"../game-start-command":67,"@armathai/lego":281}],4:[function(require,module,exports){
'use strict';
...
},{"../../../constants":146,"./show-cta-command":10,"@armathai/lego":281}],5:[function(require,module,exports){
'use strict';
...
},{"../../../constants":146,"../../../guards/ad/cta-previsible-guard":156,"../set-ad-status-command":36,"@armathai/lego":281}],6:[function(require,module,exports){
'use strict';
...
},{"../../../constants":146,"../../../guards/ad/ad-live-guard":153,"../../../guards/ad/asec-guard":154,"../../../guards/ad/cta-visible-guard":157,"../set-ad-status-command":36,"@armathai/lego":281}],7:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],8:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],9:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.scoreToCtaCompleteCommand = scoreToCtaCompleteCommand;
...
function scoreToCtaCompleteCommand() {
  var ctaType = CI_API.Globals.PARAMS.cta_type;

  _lego.lego.command
  //
  .payload(_constants.GameOverReasons.ScoreToCtaReached, ctaType === 'embedded' ? 0 : 1000).execute(_showCtaCommand.showCtaCommand);
}

},{"../../../constants":146,"./show-cta-command":10,"@armathai/lego":281}],10:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],11:[function(require,module,exports){
'use strict';
...
},{"../../models/store":215}],12:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],13:[function(require,module,exports){
'use strict';
...
},{"./set-hint-visible-command":15,"@armathai/lego":281}],14:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],15:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],16:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],17:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],18:[function(require,module,exports){
'use strict';
...
},{"../../models/store":215}],19:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.destroyJoystickModelCommand = destroyJoystickModelCommand;

var _store = require('../../../models/store');

function destroyJoystickModelCommand() {
  _store.store.ad.destroyJoystickModel();
}

},{"../../../models/store":215}],20:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initializeJoystickModelCommand = initializeJoystickModelCommand;

var _store = require('../../../models/store');

function initializeJoystickModelCommand() {
  _store.store.ad.initializeJoystickModel();
}

},{"../../../models/store":215}],21:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onJoystickPressedCommand = onJoystickPressedCommand;

var _lego = require('@armathai/lego');

var _constants = require('../../../constants');

var _setJoystickStateCommand = require('./set-joystick-state-command');

function onJoystickPressedCommand() {
  _lego.lego.command.payload(_constants.JoystickState.Pressed).execute(_setJoystickStateCommand.setJoystickStateCommand);
}

},{"../../../constants":146,"./set-joystick-state-command":24,"@armathai/lego":281}],22:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onJoystickReleasedCommand = onJoystickReleasedCommand;
...
function onJoystickReleasedCommand() {
  _lego.lego.command
  //
  .payload(_constants.JoystickState.Enable).execute(_setJoystickStateCommand.setJoystickStateCommand).execute(_userInteractionCommand.userInteractionCommand);
}

},{"../../../constants":146,"../../view/user-interaction-command":119,"./set-joystick-state-command":24,"@armathai/lego":281}],23:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onJoystickStateUpdate = onJoystickStateUpdate;
...
var _hideHintCommand = require('../hint/hide-hint-command');

var _startHintVisibilityTimerCommand = require('../hint/start-hint-visibility-timer-command');

var _stopHintVisibilityTimerCommand = require('../hint/stop-hint-visibility-timer-command');

function onJoystickStateUpdate(state) {
  switch (state) {
    case _constants.JoystickState.Pressed:
      _lego.lego.command.guard(_hintModelGuard.hintModelGuard).execute(_hideHintCommand.hideHintCommand, _stopHintVisibilityTimerCommand.stopHintVisibilityTimerCommand);
      break;
    case _constants.JoystickState.Enable:
      _lego.lego.command.guard(_hintModelGuard.hintModelGuard, (0, _lego.not)(_hintVisibleGuard.hintVisibleGuard)).execute(_startHintVisibilityTimerCommand.startHintVisibilityTimerCommand);
      break;
    default:
      break;
  }
...
},{"../../../constants":146,"../../../guards/ad/hint-model-guard":159,"../../../guards/ad/hint-visible-guard":161,"../hint/hide-hint-command":13,"../hint/start-hint-visibility-timer-command":16,"../hint/stop-hint-visibility-timer-command":17,"@armathai/lego":281}],24:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setJoystickStateCommand = setJoystickStateCommand;

var _store = require('../../../models/store');

function setJoystickStateCommand(value) {
  _store.store.ad.joystick.state = value;
}

},{"../../../models/store":215}],25:[function(require,module,exports){
'use strict';
...
},{"../../events/model-events":151,"./ad-status-update-command":2,"@armathai/lego":281}],26:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],27:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],28:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.destroyPowerUpModelCommand = destroyPowerUpModelCommand;

var _store = require('../../../models/store');

function destroyPowerUpModelCommand() {
  _store.store.ad.destroyPowerUpModel();
}

},{"../../../models/store":215}],29:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.disablePowerUpCommand = disablePowerUpCommand;

var _lego = require('@armathai/lego');

var _constants = require('../../../constants');

var _setPowerUpStateCommand = require('./set-power-up-state-command');

function disablePowerUpCommand() {
  _lego.lego.command
  //
  .payload(_constants.PowerUpState.Disable).execute(_setPowerUpStateCommand.setPowerUpStateCommand);
}

},{"../../../constants":146,"./set-power-up-state-command":34,"@armathai/lego":281}],30:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.enablePowerUpCommand = enablePowerUpCommand;
...
function enablePowerUpCommand() {
  _lego.lego.command
  //
  .payload(_constants.PowerUpState.Enable).execute(_setPowerUpStateCommand.setPowerUpStateCommand);
}

},{"../../../constants":146,"./set-power-up-state-command":34,"@armathai/lego":281}],31:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initializePowerUpModelCommand = initializePowerUpModelCommand;

var _store = require('../../../models/store');

function initializePowerUpModelCommand() {
  _store.store.ad.initializePowerUpModel();
}

},{"../../../models/store":215}],32:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onPowerUpPressCommand = onPowerUpPressCommand;
...
var _powerUpCommand = require('../../snake/power-up-command');
...
function onPowerUpPressCommand() {
  _lego.lego.command
  //
  .payload(_constants.PowerUpState.Pressed).execute(_setPowerUpStateCommand.setPowerUpStateCommand).payload(_store.store.game.boardModel.playerSnake.uuid).execute(_powerUpCommand.powerUpCommand).guard(_hintModelGuard.hintModelGuard).execute(_hideHintCommand.hideHintCommand, _stopHintVisibilityTimerCommand.stopHintVisibilityTimerCommand);
}

},{"../../../constants":146,"../../../guards/ad/hint-model-guard":159,"../../../models/store":215,"../../snake/power-up-command":93,"../hint/hide-hint-command":13,"../hint/stop-hint-visibility-timer-command":17,"./set-power-up-state-command":34,"@armathai/lego":281}],33:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onPowerUpReleaseCommand = onPowerUpReleaseCommand;

var _lego = require('@armathai/lego');

var _hintModelGuard = require('../../../guards/ad/hint-model-guard');

var _joystickStateEnableGuard = require('../../../guards/ad/joystick-state-enable-guard');

var _hasEnoughEnergyForPowerUpGuard = require('../../../guards/board/has-enough-energy-for-power-up-guard');
...
var _disablePowerUpCommand = require('./disable-power-up-command');

var _enablePowerUpCommand = require('./enable-power-up-command');

function onPowerUpReleaseCommand() {
  _lego.lego.command
  //
  .payload(_store.store.game.boardModel.playerSnake.uuid).guard(_hasEnoughEnergyForPowerUpGuard.hasEnoughEnergyForPowerUpGuard).execute(_enablePowerUpCommand.enablePowerUpCommand).payload(_store.store.game.boardModel.playerSnake.uuid).guard((0, _lego.not)(_hasEnoughEnergyForPowerUpGuard.hasEnoughEnergyForPowerUpGuard)).execute(_disablePowerUpCommand.disablePowerUpCommand).payload(_store.store.game.boardModel.playerSnake.uuid).execute(_resetPowerUpCommand.resetPowerUpCommand).guard(_joystickStateEnableGuard.joystickStateEnableGuard, _hintModelGuard.hintModelGuard).execute(_startHintVisibilityTimerCommand.startHintVisibilityTimerCommand);
}

},{"../../../guards/ad/hint-model-guard":159,"../../../guards/ad/joystick-state-enable-guard":164,"../../../guards/board/has-enough-energy-for-power-up-guard":181,"../../../models/store":215,"../../snake/reset-power-up-command":95,"../hint/start-hint-visibility-timer-command":16,"./disable-power-up-command":29,"./enable-power-up-command":30,"@armathai/lego":281}],34:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setPowerUpStateCommand = setPowerUpStateCommand;

var _store = require('../../../models/store');

function setPowerUpStateCommand(value) {
  _store.store.ad.powerUp.state = value;
}

},{"../../../models/store":215}],35:[function(require,module,exports){
"use strict";
...
},{"../../models/store":215}],37:[function(require,module,exports){
'use strict';
...
},{"../../kernel/globals":192}],38:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],39:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],40:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],41:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.destroyTimerModelCommand = destroyTimerModelCommand;

var _store = require('../../../models/store');

function destroyTimerModelCommand() {
  _store.store.ad.destroyTimerModel();
}

},{"../../../models/store":215}],42:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],43:[function(require,module,exports){
'use strict';
...
function startTimerCommand() {
  _store.store.ad.timer.startTimer(CI_API.Globals.PARAMS.game_timer);
}

},{"../../../models/store":215}],44:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],45:[function(require,module,exports){
'use strict';
...
var _timerCompleteGuard = require('../../../guards/timer/timer-complete-guard');
...
},{"../../../guards/timer/timer-complete-guard":188,"./timer-to-cta-command":46,"@armathai/lego":281}],46:[function(require,module,exports){
'use strict';
...
function timerToCtaCommand() {
  _lego.lego.command
  //
  .payload(_constants.GameOverReasons.TimerToCta, 0).execute(_showCtaCommand.showCtaCommand);
}

},{"../../../constants":146,"../cta/show-cta-command":10,"@armathai/lego":281}],47:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],48:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],49:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],50:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],51:[function(require,module,exports){
'use strict';
...
var _joystickStatePressedGuard = require('../../../guards/ad/joystick-state-pressed-guard');

var _persistentCtaParamGuard = require('../../../guards/ad/persistent-cta-param-guard');

var _gamePointerExistGuard = require('../../../guards/game/game-pointer-exist-guard');
...
function onTutorialCompleteCommand() {
  _lego.lego.command
  //
  .guard(_persistentCtaParamGuard.persistentCtaParamGuard).execute(_initializePersistentCtaModelCommand.initializePersistentCtaModelCommand).guard((0, _lego.not)(_hintModelGuard.hintModelGuard), _hintParamGuard.hintParamGuard).execute(_initializeHintModelCommand.initializeHintModelCommand).guard(_joystickModelGuard.joystickModelGuard, (0, _lego.not)(_joystickStatePressedGuard.joystickStatePressedGuard)).execute(_startHintVisibilityTimerCommand.startHintVisibilityTimerCommand).guard((0, _lego.not)(_joystickModelGuard.joystickModelGuard), (0, _lego.not)(_gamePointerExistGuard.gamePointerExistGuard)).execute(_startHintVisibilityTimerCommand.startHintVisibilityTimerCommand);
}

},{"../../../guards/ad/hint-model-guard":159,"../../../guards/ad/hint-param-guard":160,"../../../guards/ad/joystick-model-guard":162,"../../../guards/ad/joystick-state-pressed-guard":165,"../../../guards/ad/persistent-cta-param-guard":167,"../../../guards/game/game-pointer-exist-guard":185,"../hint/initialize-hint-model-command":14,"../hint/start-hint-visibility-timer-command":16,"../pcta/initialize-persistent-cta-model-command":27,"@armathai/lego":281}],52:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onTutorialHideCompleteCommand = onTutorialHideCompleteCommand;

var _lego = require('@armathai/lego');

var _destroyTutorialModelCommand = require('./destroy-tutorial-model-command');

function onTutorialHideCompleteCommand() {
  _lego.lego.command
  //
  .execute(_destroyTutorialModelCommand.destroyTutorialModelCommand);
}

},{"./destroy-tutorial-model-command":48,"@armathai/lego":281}],53:[function(require,module,exports){
"use strict";
...
},{"../../../guards/ad/hint-model-guard":159,"../../../guards/ad/hint-param-guard":160,"../../../guards/ad/persistent-cta-param-guard":167,"../hint/initialize-hint-model-command":14,"../hint/start-hint-visibility-timer-command":16,"../pcta/initialize-persistent-cta-model-command":27,"./destroy-tutorial-model-command":48,"@armathai/lego":281}],55:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],56:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],57:[function(require,module,exports){
'use strict';
...
},{"../../../models/store":215}],58:[function(require,module,exports){
'use strict';
...
},{"./complete-tutorial-sequence-command":47,"@armathai/lego":281}],59:[function(require,module,exports){
'use strict';
...
},{"../../../guards/ad/tutorial-last-sequence-guard":175,"../../../guards/ad/tutorial-model-guard":176,"./next-tutorial-sequence-command":50,"./set-tutorial-complete-command":55,"./show-tutorial-sequence-command":57,"@armathai/lego":281}],60:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.makeFoodCommand = makeFoodCommand;

var _store = require('../../models/store');

function makeFoodCommand(data) {
...
},{"../../models/store":215}],61:[function(require,module,exports){
'use strict';
...
},{"../../models/store":215}],62:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onFoodStateUpdateCommand = onFoodStateUpdateCommand;

var _lego = require('@armathai/lego');

var _boardIdleStateGuard = require('../../guards/board/board-idle-state-guard');

var _foodEatenGuard = require('../../guards/board/food-eaten-guard');

var _removeFoodCommand = require('./remove-food-command');

function onFoodStateUpdateCommand(state, prevState, uuid) {
  _lego.lego.command
  //
  .payload(uuid).guard(_boardIdleStateGuard.boardIdleStateGuard, _foodEatenGuard.foodEatenGuard).execute(_removeFoodCommand.removeFoodCommand);
}

},{"../../guards/board/board-idle-state-guard":178,"../../guards/board/food-eaten-guard":180,"./remove-food-command":63,"@armathai/lego":281}],63:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.removeFoodCommand = removeFoodCommand;

var _store = require('../../models/store');

function removeFoodCommand(uuid) {
  _store.store.game.boardModel.removeFood(uuid);
}

},{"../../models/store":215}],64:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setFoodEatenCommand = setFoodEatenCommand;

var _constants = require('../../constants');

var _store = require('../../models/store');

function setFoodEatenCommand(uuid) {
  var food = _store.store.game.boardModel.getFoodByUuid(uuid);
  food && (food.state = _constants.FoodState.Eaten);
}

},{"../../constants":146,"../../models/store":215}],65:[function(require,module,exports){
'use strict';
...
},{"./ad/reset-time-command":35,"@armathai/lego":281}],66:[function(require,module,exports){
'use strict';
...
},{"../constants":146,"../guards/ad/tutorial-model-guard":176,"./ad/set-ad-status-command":36,"./ad/set-last-interaction-command":37,"./ad/tutorial/set-tutorial-skip-command":56,"./game/unmap-playable-commands-command":73,"./shutdown-models-command":88,"@armathai/lego":281}],67:[function(require,module,exports){
'use strict';
...
},{"../constants":146,"./ad/map-ad-status-update-command":25,"./ad/set-ad-status-command":36,"@armathai/lego":281}],68:[function(require,module,exports){
'use strict';
...
},{"../../models/store":215}],69:[function(require,module,exports){
'use strict';
...
function gameOverCommand() {
  _lego.lego.command
  //
  .payload(_constants.GameOverReasons.Failed, 500).execute(_showCtaCommand.showCtaCommand);
}

},{"../../constants":146,"../ad/cta/show-cta-command":10,"@armathai/lego":281}],70:[function(require,module,exports){
'use strict';
...
},{"../../models/store":215}],71:[function(require,module,exports){
'use strict';
...
},{"../../configs/lego-config":140,"@armathai/lego":281}],72:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setGamePointerCommand = setGamePointerCommand;

var _store = require('../../models/store');

function setGamePointerCommand(value) {
  _store.store.game.pointer = value;
}

},{"../../models/store":215}],73:[function(require,module,exports){
'use strict';
...
},{"../../configs/lego-config":140,"@armathai/lego":281}],74:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.destroyIndicatorModelCommand = destroyIndicatorModelCommand;

var _store = require('../../models/store');

function destroyIndicatorModelCommand() {
  _store.store.ad.destroyPlayableIndicatorModel();
}

},{"../../models/store":215}],75:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onIndicatorVisibleUpdateCommand = onIndicatorVisibleUpdateCommand;

var _lego = require('@armathai/lego');

var _playableIndicatorVisibleGuard = require('../../guards/ad/playable-indicator-visible-guard');

var _destroyIndicatorModelCommand = require('./destroy-indicator-model-command');

function onIndicatorVisibleUpdateCommand() {
  _lego.lego.command.guard(_playableIndicatorVisibleGuard.playableIndicatorVisibleGuard).execute(_destroyIndicatorModelCommand.destroyIndicatorModelCommand);
}

},{"../../guards/ad/playable-indicator-visible-guard":170,"./destroy-indicator-model-command":74,"@armathai/lego":281}],76:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initializePlayableIndicatorModelCommand = initializePlayableIndicatorModelCommand;

var _store = require('../../models/store');

function initializePlayableIndicatorModelCommand() {
  _store.store.ad.initializePlayableIndicator();
}

},{"../../models/store":215}],77:[function(require,module,exports){
'use strict';
...
var _gameHasBeenRetriedGuard = require('../guards/ad/game-has-been-retried-guard');

var _hintModelGuard = require('../guards/ad/hint-model-guard');

var _hintParamGuard = require('../guards/ad/hint-param-guard');

var _joystickParamGuard = require('../guards/ad/joystick-param-guard');

var _persistentCtaParamGuard = require('../guards/ad/persistent-cta-param-guard');

var _playableIndicatorParamGuard = require('../guards/ad/playable-indicator-param-guard');

var _powerUpParamGuard = require('../guards/ad/power-up-param-guard');
...
var _timerParamGuard = require('../guards/timer/timer-param-guard');
...
var _initializeJoystickModelCommand = require('./ad/joystick/initialize-joystick-model-command');

var _initializePersistentCtaModelCommand = require('./ad/pcta/initialize-persistent-cta-model-command');

var _initializePowerUpModelCommand = require('./ad/power_up/initialize-power-up-model-command');
...
var _initializeIndicatorModelCommand = require('./indicator/initialize-indicator-model-command');

var _initializePlayerModelCommand = require('./player/initialize-player-model-command');

function initializeModelsCommand() {
  _lego.lego.command.execute(_initializePlayerModelCommand.initializePlayerModelCommand).execute(_initializeGameModelCommand.initializeGameModelCommand).execute(_initializeCtaModelCommand.initializeCtaModelCommand).guard((0, _lego.not)(_soundModelGuard.soundModelGuard), _soundParamGuard.soundParamGuard).execute(_initializeSoundModelCommand.initializeSoundModelCommand).guard(_timerParamGuard.timerParamGuard).execute(_initializeTimerModelCommand.initializeTimerModelCommand).guard(_joystickParamGuard.joystickParamGuard).execute(_initializeJoystickModelCommand.initializeJoystickModelCommand).guard(_powerUpParamGuard.powerUpParamGuard).execute(_initializePowerUpModelCommand.initializePowerUpModelCommand).guard((0, _lego.not)(_gameHasBeenRetriedGuard.gameHasBeenRetriedGuard), _tutorialParamGuard.tutorialParamGuard).execute(_initializeTutorialModelCommand.initializeTutorialModelCommand).guard((0, _lego.not)(_tutorialModelGuard.tutorialModelGuard), _persistentCtaParamGuard.persistentCtaParamGuard).execute(_initializePersistentCtaModelCommand.initializePersistentCtaModelCommand).guard((0, _lego.not)(_hintModelGuard.hintModelGuard), (0, _lego.not)(_tutorialModelGuard.tutorialModelGuard), _hintParamGuard.hintParamGuard).execute(_initializeHintModelCommand.initializeHintModelCommand, _startHintVisibilityTimerCommand.startHintVisibilityTimerCommand).guard((0, _lego.not)(_gameHasBeenRetriedGuard.gameHasBeenRetriedGuard), _playableIndicatorParamGuard.playableIndicatorParamGuard).execute(_initializeIndicatorModelCommand.initializePlayableIndicatorModelCommand);
}

},{"../guards/ad/game-has-been-retried-guard":158,"../guards/ad/hint-model-guard":159,"../guards/ad/hint-param-guard":160,"../guards/ad/joystick-param-guard":163,"../guards/ad/persistent-cta-param-guard":167,"../guards/ad/playable-indicator-param-guard":169,"../guards/ad/power-up-param-guard":172,"../guards/ad/sound-model-guard":173,"../guards/ad/sound-param-guard":174,"../guards/ad/tutorial-model-guard":176,"../guards/ad/tutorial-param-guard":177,"../guards/timer/timer-param-guard":190,"./ad/cta/initialize-cta-model-command":8,"./ad/hint/initialize-hint-model-command":14,"./ad/hint/start-hint-visibility-timer-command":16,"./ad/joystick/initialize-joystick-model-command":20,"./ad/pcta/initialize-persistent-cta-model-command":27,"./ad/power_up/initialize-power-up-model-command":31,"./ad/sound/initialize-sound-model-command":39,"./ad/timer/initialize-timer-model-command":42,"./ad/tutorial/initialize-tutorial-model-command":49,"./game/initialize-game-model-command":70,"./indicator/initialize-indicator-model-command":76,"./player/initialize-player-model-command":82,"@armathai/lego":281}],78:[function(require,module,exports){
'use strict';
...
},{"../../observants/analytics-observant":252}],79:[function(require,module,exports){
'use strict';
...
},{"../../observants/sound-observant":253}],80:[function(require,module,exports){
'use strict';
...
},{"../../observants/wrapper-observant":254}],81:[function(require,module,exports){
'use strict';
...
},{"../../models/store":215}],82:[function(require,module,exports){
'use strict';
...
},{"../../models/store":215}],83:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onScoreUpdateCommand = onScoreUpdateCommand;

var _lego = require('@armathai/lego');

var _scoreToCtaReachedGuard = require('../../guards/game/score-to-cta-reached-guard');

var _scoreToCtaCompleteCommand = require('../ad/cta/score-to-cta-complete-command');

function onScoreUpdateCommand() {
  _lego.lego.command
  //
  .guard(_scoreToCtaReachedGuard.scoreToCtaReachedGuard).execute(_scoreToCtaCompleteCommand.scoreToCtaCompleteCommand);
}

},{"../../guards/game/score-to-cta-reached-guard":186,"../ad/cta/score-to-cta-complete-command":9,"@armathai/lego":281}],84:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setScoreCommand = setScoreCommand;

var _store = require('../../models/store');

function setScoreCommand(value) {
  _store.store.player.score = value;
}

},{"../../models/store":215}],85:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateScoreCommand = updateScoreCommand;

var _lego = require('@armathai/lego');

var _store = require('../../models/store');

var _setScoreCommand = require('./set-score-command');

function updateScoreCommand(snakeUuid) {
  var game = _store.store.game;
  var boardModel = game.boardModel;

  var _boardModel$getSnakeB = boardModel.getSnakeByUuid(snakeUuid),
      energy = _boardModel$getSnakeB.energy;

  _lego.lego.command
  //
  .payload(energy * CI_API.Globals.PARAMS.score_multiplier).execute(_setScoreCommand.setScoreCommand);
}

},{"../../models/store":215,"./set-score-command":84,"@armathai/lego":281}],86:[function(require,module,exports){
'use strict';
...
function resizeCommand() {
  _lego.lego.command
  //
  .guard(_hintModelGuard.hintModelGuard).execute(_hideHintCommand.hideHintCommand, _stopHintVisibilityTimerCommand.stopHintVisibilityTimerCommand, _startHintVisibilityTimerCommand.startHintVisibilityTimerCommand);
}

},{"../guards/ad/hint-model-guard":159,"./ad/hint/hide-hint-command":13,"./ad/hint/start-hint-visibility-timer-command":16,"./ad/hint/stop-hint-visibility-timer-command":17,"@armathai/lego":281}],87:[function(require,module,exports){
'use strict';
...
},{"../constants":146,"./ad/set-ad-status-command":36,"@armathai/lego":281}],88:[function(require,module,exports){
'use strict';
...
var _destroyJoystickModelCommand = require('./ad/joystick/destroy-joystick-model-command');

var _destroyPersistentCtaModelCommand = require('./ad/pcta/destroy-persistent-cta-model-command');

var _destroyPowerUpModelCommand = require('./ad/power_up/destroy-power-up-model-command');

var _destroySoundModelCommand = require('./ad/sound/destroy-sound-model-command');

var _destroyTimerModelCommand = require('./ad/timer/destroy-timer-model-command');

var _stopTimerCommand = require('./ad/timer/stop-timer-command');
...
function shutdownModelsCommand() {
  _lego.lego.command.guard(_playerModelGuard.playerModelGuard).execute(_destroyPlayerModelCommand.destroyPlayerModelCommand).guard(_timerModelGuard.timerModelGuard).execute(_stopTimerCommand.stopTimerCommand, _destroyTimerModelCommand.destroyTimerModelCommand).guard(_joystickModelGuard.joystickModelGuard).execute(_destroyJoystickModelCommand.destroyJoystickModelCommand).guard(_powerUpModelGuard.powerUpModelGuard).execute(_destroyPowerUpModelCommand.destroyPowerUpModelCommand).guard(_gameModelGuard.gameModelGuard).execute(_destroyGameModelCommand.destroyGameModelCommand).guard(_ctaModelGuard.ctaModelGuard).execute(_destroyCtaModelCommand.destroyCtaModelCommand).guard(_soundParamGuard.soundParamGuard).execute(_destroySoundModelCommand.destroySoundModelCommand).guard(_hintModelGuard.hintModelGuard).execute(_destroyHintModelCommand.destroyHintModelCommand).guard(_persistentCtaModelGuard.persistentCtaModelGuard).execute(_destroyPersistentCtaModelCommand.destroyPersistentCtaModelCommand).guard(_playableIndicatorGuard.playableIndicatorGuard).execute(_destroyIndicatorModelCommand.destroyIndicatorModelCommand);
}

},{"../guards/ad/cta-model-guard":155,"../guards/ad/hint-model-guard":159,"../guards/ad/joystick-model-guard":162,"../guards/ad/persistent-cta-model-guard":166,"../guards/ad/playable-indicator-guard":168,"../guards/ad/power-up-model-guard":171,"../guards/ad/sound-param-guard":174,"../guards/game/game-model-guard":184,"../guards/player/player-model-guard":187,"../guards/timer/timer-model-guard":189,"./ad/cta/destroy-cta-model-command":7,"./ad/hint/destroy-hint-model-command":12,"./ad/joystick/destroy-joystick-model-command":19,"./ad/pcta/destroy-persistent-cta-model-command":26,"./ad/power_up/destroy-power-up-model-command":28,"./ad/sound/destroy-sound-model-command":38,"./ad/timer/destroy-timer-model-command":41,"./ad/timer/stop-timer-command":44,"./game/destroy-game-model-command":68,"./indicator/destroy-indicator-model-command":74,"./player/destroy-player-model-command":81,"@armathai/lego":281}],89:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.boostSnakeSpeedCommand = boostSnakeSpeedCommand;

var _store = require('../../models/store');

function boostSnakeSpeedCommand(snakeUuid) {
  var snake = _store.store.game.boardModel.getSnakeByUuid(snakeUuid);
  snake.speed *= 2;
}

},{"../../models/store":215}],90:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.makeSnakeFragmentationCommand = makeSnakeFragmentationCommand;

var _store = require('../../models/store');

function makeSnakeFragmentationCommand(uuid) {
  var boardModel = _store.store.game.boardModel;

  var snake = boardModel.getSnakeByUuid(uuid);
  boardModel.makeFragments(snake);
}

},{"../../models/store":215}],91:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onSnakeEnergyUpdateCommand = onSnakeEnergyUpdateCommand;

var _lego = require('@armathai/lego');

var _isPlayerSnakeGuard = require('../../guards/board/is-player-snake-guard');

var _updateScoreCommand = require('../player/update-score-command');

function onSnakeEnergyUpdateCommand(energy, prevValue, uuid) {
  _lego.lego.command
  //
  .payload(uuid).guard(_isPlayerSnakeGuard.isPlayerSnakeGuard).execute(_updateScoreCommand.updateScoreCommand);
}

},{"../../guards/board/is-player-snake-guard":182,"../player/update-score-command":85,"@armathai/lego":281}],92:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onSnakeStateUpdateCommand = onSnakeStateUpdateCommand;

var _lego = require('@armathai/lego');

var _boardUnknownStateGuard = require('../../guards/board/board-unknown-state-guard');

var _isPlayerSnakeGuard = require('../../guards/board/is-player-snake-guard');

var _snakeDeadGuard = require('../../guards/board/snake-dead-guard');

var _gameOverCommand = require('../game/game-over-command');

var _makeSnakeFragmentationCommand = require('./make-snake-fragmentation-command');

var _removeSnakeCommand = require('./remove-snake-command');

function onSnakeStateUpdateCommand(state, prevState, uuid) {
  _lego.lego.command
  //
  .payload(uuid).guard((0, _lego.not)(_boardUnknownStateGuard.boardUnknownStateGuard), _snakeDeadGuard.snakeDeadGuard).execute(_makeSnakeFragmentationCommand.makeSnakeFragmentationCommand).payload(uuid).guard(_isPlayerSnakeGuard.isPlayerSnakeGuard, _snakeDeadGuard.snakeDeadGuard).execute(_gameOverCommand.gameOverCommand).payload(uuid).guard((0, _lego.not)(_boardUnknownStateGuard.boardUnknownStateGuard), _snakeDeadGuard.snakeDeadGuard).execute(_removeSnakeCommand.removeSnakeCommand);
}

},{"../../guards/board/board-unknown-state-guard":179,"../../guards/board/is-player-snake-guard":182,"../../guards/board/snake-dead-guard":183,"../game/game-over-command":69,"./make-snake-fragmentation-command":90,"./remove-snake-command":94,"@armathai/lego":281}],93:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.powerUpCommand = powerUpCommand;

var _store = require('../../models/store');

function powerUpCommand(snakeUuid) {
  var snake = _store.store.game.boardModel.getSnakeByUuid(snakeUuid);
  snake.powerUp = true;
}

},{"../../models/store":215}],94:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.removeSnakeCommand = removeSnakeCommand;

var _store = require('../../models/store');

function removeSnakeCommand(uuid) {
  _store.store.game.boardModel.removeSnake(uuid);
}

},{"../../models/store":215}],95:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.resetPowerUpCommand = resetPowerUpCommand;

var _store = require('../../models/store');

function resetPowerUpCommand(snakeUuid) {
  var snake = _store.store.game.boardModel.getSnakeByUuid(snakeUuid);
  snake.powerUp = false;
}

},{"../../models/store":215}],96:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.resetSnakeSpeedCommand = resetSnakeSpeedCommand;

var _constants = require('../../constants');

var _store = require('../../models/store');

function resetSnakeSpeedCommand(snakeUuid) {
  var snake = _store.store.game.boardModel.getSnakeByUuid(snakeUuid);
  var isPlayer = snake.isPlayer;


  snake.speed = isPlayer ? _constants.PlayerSpeed[CI_API.Globals.PARAMS.player_speed] : _constants.EnemySpeed[CI_API.Globals.PARAMS.enemy_snake_speed];
}

},{"../../constants":146,"../../models/store":215}],97:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setSnakeDeadCommand = setSnakeDeadCommand;

var _constants = require('../../constants');

var _store = require('../../models/store');

function setSnakeDeadCommand(uuid) {
  var snake = _store.store.game.boardModel.getSnakeByUuid(uuid);
  snake && (snake.state = _constants.SnakeState.Dead);
}

},{"../../constants":146,"../../models/store":215}],98:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.startEnergyConsumptionCommand = startEnergyConsumptionCommand;

var _store = require('../../models/store');

function startEnergyConsumptionCommand(snakeUuid) {
  var snake = _store.store.game.boardModel.getSnakeByUuid(snakeUuid);
  snake.startEnergyConsumption();
}

},{"../../models/store":215}],99:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.stopEnergyConsumptionCommand = stopEnergyConsumptionCommand;

var _store = require('../../models/store');

function stopEnergyConsumptionCommand(snakeUuid) {
  var snake = _store.store.game.boardModel.getSnakeByUuid(snakeUuid);
  snake.stopEnergyConsumption();
}

},{"../../models/store":215}],100:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateSnakeEnergyCommand = updateSnakeEnergyCommand;

var _constants = require('../../constants');

var _store = require('../../models/store');

function updateSnakeEnergyCommand(snakeUuid, foodUuid) {
  var boardModel = _store.store.game.boardModel;

  var snake = boardModel.getSnakeByUuid(snakeUuid);
  var food = boardModel.getFoodByUuid(foodUuid);
  var type = food.type;


  snake.updateEnergy(_constants.foodWeight[type]);
}

},{"../../constants":146,"../../models/store":215}],101:[function(require,module,exports){
'use strict';
...
},{"../events/model-events":151,"../events/view-events":152,"../guards/ad/sound-param-guard":174,"./ad/ad-live-command":1,"./ad/ad-view-state-update-command":3,"./ad/cta/cta-idle-time-command":4,"./ad/cta/cta-visible-update-command":6,"./ad/initialize-ad-model-command":18,"./ad/sound/set-sound-state-command":40,"./observants/initialize-analytics-observant-command":78,"./observants/initialize-sound-observant-command":79,"./observants/initialize-wrapper-observant-command":80,"./resize-command":86,"./states/initialize-phaser-states-command":102,"./view/initialize-ninepatches-command":105,"./view/initialize-particles-command":106,"./view/on-retry-click-command":111,"./view/patch-text-for-localization-command":118,"./view/user-interaction-command":119,"@armathai/lego":281}],102:[function(require,module,exports){
'use strict';
...
},{"../../constants":146,"../../states/game-state":255,"../../states/preloader-state":256}],103:[function(require,module,exports){
"use strict";
...
},{"../../constants":146}],105:[function(require,module,exports){
'use strict';
...
},{"../../configs/ninepatch-configs":141,"@armathai/phaser2-ninepatch":289}],106:[function(require,module,exports){
'use strict';
...
},{"../../configs/particles-configs":142}],107:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onFirstClickOnControllerCommand = onFirstClickOnControllerCommand;
...
function onFirstClickOnControllerCommand() {
  _lego.lego.command
  //
  .payload(_constants.BoardState.Idle).execute(_setBoardStateCommand.setBoardStateCommand).guard(_timerModelGuard.timerModelGuard).execute(_startTimerCommand.startTimerCommand);
}

},{"../../constants":146,"../../guards/timer/timer-model-guard":189,"../ad/timer/start-timer-command":43,"../board/set-board-state-command":61,"@armathai/lego":281}],108:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onFragmentsDropCommand = onFragmentsDropCommand;

var _lego = require('@armathai/lego');

var _makeFoodCommand = require('../board/make-food-command');

function onFragmentsDropCommand(data) {
  _lego.lego.command
  //
  .payload(data).execute(_makeFoodCommand.makeFoodCommand);
}

},{"../board/make-food-command":60,"@armathai/lego":281}],109:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onGameViewInputDown = onGameViewInputDown;
...
var _setGamePointerCommand = require('../game/set-game-pointer-command');

function onGameViewInputDown() {
  _lego.lego.command
  //
  .payload(true).execute(_setGamePointerCommand.setGamePointerCommand).guard(_hintModelGuard.hintModelGuard).execute(_hideHintCommand.hideHintCommand, _stopHintVisibilityTimerCommand.stopHintVisibilityTimerCommand);
}

},{"../../guards/ad/hint-model-guard":159,"../ad/hint/hide-hint-command":13,"../ad/hint/stop-hint-visibility-timer-command":17,"../game/set-game-pointer-command":72,"@armathai/lego":281}],110:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onGameViewInputUp = onGameViewInputUp;
...
var _userInteractionCommand = require('./user-interaction-command');

function onGameViewInputUp() {
  _lego.lego.command
  //
  .payload(false).execute(_setGamePointerCommand.setGamePointerCommand).guard(_hintModelGuard.hintModelGuard).execute(_startHintVisibilityTimerCommand.startHintVisibilityTimerCommand).execute(_userInteractionCommand.userInteractionCommand);
}

},{"../../guards/ad/hint-model-guard":159,"../ad/hint/start-hint-visibility-timer-command":16,"../game/set-game-pointer-command":72,"./user-interaction-command":119,"@armathai/lego":281}],111:[function(require,module,exports){
'use strict';
...
},{"../ad/decrease-retries-count-command":11,"../retry-command":87,"@armathai/lego":281}],112:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onSnakeAbleToBoostUpdateCommand = onSnakeAbleToBoostUpdateCommand;
...
var _disablePowerUpCommand = require('../ad/power_up/disable-power-up-command');

var _enablePowerUpCommand = require('../ad/power_up/enable-power-up-command');

var _resetPowerUpCommand = require('../snake/reset-power-up-command');

function onSnakeAbleToBoostUpdateCommand(ableToBoost, prevValue, uuid) {
  _lego.lego.command
  //
  .payload(uuid).guard(_powerUpModelGuard.powerUpModelGuard, _isPlayerSnakeGuard.isPlayerSnakeGuard, function () {
    return ableToBoost;
  }).execute(_enablePowerUpCommand.enablePowerUpCommand).payload(uuid).guard(_powerUpModelGuard.powerUpModelGuard, _isPlayerSnakeGuard.isPlayerSnakeGuard, function () {
    return !ableToBoost;
  }).execute(_disablePowerUpCommand.disablePowerUpCommand).payload(uuid).execute(_resetPowerUpCommand.resetPowerUpCommand);
}

},{"../../guards/ad/power-up-model-guard":171,"../../guards/board/is-player-snake-guard":182,"../ad/power_up/disable-power-up-command":29,"../ad/power_up/enable-power-up-command":30,"../snake/reset-power-up-command":95,"@armathai/lego":281}],113:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onSnakeBitesCommand = onSnakeBitesCommand;

var _lego = require('@armathai/lego');

var _store = require('../../models/store');

var _setSnakeDeadCommand = require('../snake/set-snake-dead-command');

function onSnakeBitesCommand(data) {
  var biter = data.biter,
      bitten = data.bitten; // bitten

  var boardModel = _store.store.game.boardModel;

  var biterSnake = boardModel.getSnakeByUuid(biter);
  var bittenSnake = boardModel.getSnakeByUuid(bitten);
  ...
  _lego.lego.command
  //
  .payload(killed).execute(_setSnakeDeadCommand.setSnakeDeadCommand);
}

},{"../../models/store":215,"../snake/set-snake-dead-command":97,"@armathai/lego":281}],114:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onSnakeCollideWithBorderCommand = onSnakeCollideWithBorderCommand;

var _lego = require('@armathai/lego');

var _setSnakeDeadCommand = require('../snake/set-snake-dead-command');

function onSnakeCollideWithBorderCommand(uuid) {
  _lego.lego.command.payload(uuid).execute(_setSnakeDeadCommand.setSnakeDeadCommand);
}

},{"../snake/set-snake-dead-command":97,"@armathai/lego":281}],115:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onSnakeEatFoodCommand = onSnakeEatFoodCommand;

var _lego = require('@armathai/lego');

var _setFoodEatenCommand = require('../food/set-food-eaten-command');

var _updateSnakeEnergyCommand = require('../snake/update-snake-energy-command');

function onSnakeEatFoodCommand(data) {
  ...
  _lego.lego.command
  //
  .payload(snake, food).execute(_updateSnakeEnergyCommand.updateSnakeEnergyCommand).payload(food).execute(_setFoodEatenCommand.setFoodEatenCommand);
}

},{"../food/set-food-eaten-command":64,"../snake/update-snake-energy-command":100,"@armathai/lego":281}],116:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onSnakeExhaustCommand = onSnakeExhaustCommand;

var _lego = require('@armathai/lego');

var _makeFoodCommand = require('../board/make-food-command');

function onSnakeExhaustCommand(data) {
  _lego.lego.command
  //
  .payload([data]).execute(_makeFoodCommand.makeFoodCommand);
}

},{"../board/make-food-command":60,"@armathai/lego":281}],117:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onSnakePowerUpUpdateCommand = onSnakePowerUpUpdateCommand;

var _lego = require('@armathai/lego');

var _boostSnakeSpeedCommand = require('../snake/boost-snake-speed-command');

var _resetSnakeSpeedCommand = require('../snake/reset-snake-speed-command');

var _startEnergyConsumptionCommand = require('../snake/start-energy-consumption-command');

var _stopEnergyConsumptionCommand = require('../snake/stop-energy-consumption-command');

function onSnakePowerUpUpdateCommand(powerUp, prevValue, uuid) {
  _lego.lego.command
  //
  .payload(uuid).guard(function () {
    return powerUp;
  }).execute(_boostSnakeSpeedCommand.boostSnakeSpeedCommand, _startEnergyConsumptionCommand.startEnergyConsumptionCommand).payload(uuid).guard(function () {
    return !powerUp;
  }).execute(_resetSnakeSpeedCommand.resetSnakeSpeedCommand, _stopEnergyConsumptionCommand.stopEnergyConsumptionCommand);
}

},{"../snake/boost-snake-speed-command":89,"../snake/reset-snake-speed-command":96,"../snake/start-energy-consumption-command":98,"../snake/stop-energy-consumption-command":99,"@armathai/lego":281}],118:[function(require,module,exports){
'use strict';
...
},{"../ad/set-last-interaction-command":37,"@armathai/lego":281}],120:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getPagePeelAnimationConfig = getPagePeelAnimationConfig;
exports.getSnakeDeathAnimationConfig = getSnakeDeathAnimationConfig;
...
function getPagePeelAnimationConfig(x, y) {
  return {
    x: x,
    y: y,
    data: [{
...
function getSnakeDeathAnimationConfig(x, y) {
  return {
    x: x,
    y: y,
    data: [{
...
function getBoardConfig() {
  return Object.freeze([{
    player: {
      name: 'Player',
      isPlayer: true,
      initialPosition: { x: _constants.boardDimensions.width / 2, y: _constants.boardDimensions.height / 2 },
      initialDirection: -90,
      skin: _constants.SnakeSkin[CI_API.Globals.PARAMS.snake_skin]
    },
    snakes: [{
      name: 'EnemyPlayer1',
      isPlayer: false,
      ...
      initialDirection: 0,
      skin: _constants.SnakeSkin.Fire
    }, {
      name: 'EnemyPlayer2',
      isPlayer: false,
      initialPosition: { x: 250, y: 1200 },
      initialDirection: -120,
      skin: _constants.SnakeSkin.SpiritWolf
    }, {
      name: 'EnemyPlayer3',
      isPlayer: false,
      initialPosition: { x: 1200, y: 1000 },
      initialDirection: -120,
      skin: _constants.SnakeSkin.RoboTrex
    }, {
      name: 'EnemyPlayer4',
      isPlayer: false,
      initialPosition: { x: 200, y: 200 },
      initialDirection: -60,
      skin: _constants.SnakeSkin.WhiteCat
    }, {
      name: 'EnemyPlayer5',
      isPlayer: false,
      initialPosition: { x: 1200, y: 200 },
      initialDirection: -60,
      skin: _constants.SnakeSkin.StarDragon
    }]
  }, {
    player: {
      name: 'Player',
    ...
    snakes: [{
      ...
      initialDirection: -120,
      skin: _constants.SnakeSkin.Unicorn
    }, {
      name: 'EnemyPlayer3',
      isPlayer: false,
      ...
      initialPosition: { x: 200, y: 200 },
      initialDirection: -60,
      skin: _constants.SnakeSkin.Panda
    }, {
      name: 'EnemyPlayer5',
      isPlayer: false,
      initialPosition: { x: 1200, y: 200 },
    ...
    snakes: [{
      ...
      initialPosition: { x: 100, y: 500 },
      initialDirection: 0,
      skin: _constants.SnakeSkin.Dog
    }, {
      name: 'EnemyPlayer2',
      isPlayer: false,
      initialPosition: { x: 200, y: 1400 },
      initialDirection: -120,
      skin: _constants.SnakeSkin.PurpleSnake
    }, {
      name: 'EnemyPlayer3',
      isPlayer: false,
...
},{"../constants":146}],122:[function(require,module,exports){
'use strict';
...
},{"../constants":146,"./ninepatch-configs":141,"./text-configs":144}],123:[function(require,module,exports){
'use strict';
...
exports.getCTAStandardWinGridConfig = getCTAStandardWinGridConfig;
exports.getCTAStandardLoseGridConfig = getCTAStandardLoseGridConfig;
exports.getCTA3PPGridConfig = getCTA3PPGridConfig;
exports.getCTAEmbeddedGridConfig = getCTAEmbeddedGridConfig;
exports.getPagePeelCTAGridConfig = getPagePeelCTAGridConfig;
exports.getCTABottomLayerGridConfig = getCTABottomLayerGridConfig;
exports.getIndicatorGridConfig = getIndicatorGridConfig;

var _backgroundGridConfigs = require('./grid/background-grid-configs');

var _cta3ppGridConfigs = require('./grid/cta-3pp-grid-configs');

var _ctaBottomLayerGirdConfig = require('./grid/cta-bottom-layer-gird-config');
...
var _ctaPagePeelGirdConfig = require('./grid/cta-page-peel-gird-config');

var _ctaStandardLoseGridConfigs = require('./grid/cta-standard-lose-grid-configs');

var _ctaStandardWinGridConfigs = require('./grid/cta-standard-win-grid-configs');

var _foregroundGridConfigs = require('./grid/foreground-grid-configs');

var _gameGridConfigs = require('./grid/game-grid-configs');

var _indicatorGridConfigs = require('./grid/indicator-grid-configs');
...
function getCTAStandardWinGridConfig() {
  return LP(_ctaStandardWinGridConfigs.getCTAStandardWinGridLandscapeConfig, _ctaStandardWinGridConfigs.getCTAStandardWinGridPortraitConfig).call(null);
}

function getCTAStandardLoseGridConfig() {
  return LP(_ctaStandardLoseGridConfigs.getCTAStandardLoseGridLandscapeConfig, _ctaStandardLoseGridConfigs.getCTAStandardLoseGridPortraitConfig).call(null);
}

function getCTA3PPGridConfig() {
  return LP(_cta3ppGridConfigs.getCTA3PPGridLandscapeConfig, _cta3ppGridConfigs.getCTA3PPGridPortraitConfig).call(null);
}
...
function getPagePeelCTAGridConfig() {
  return LP(_ctaPagePeelGirdConfig.getPagePeelCTAGridLandscapeConfig, _ctaPagePeelGirdConfig.getPagePeelCTAGridPortraitConfig).call(null);
}

function getCTABottomLayerGridConfig() {
  return LP(_ctaBottomLayerGirdConfig.getCTABottomLayerGridLandscapeConfig, _ctaBottomLayerGirdConfig.getCTABottomLayerGridPortraitConfig).call(null);
}

function getIndicatorGridConfig(type) {
  return LP(_indicatorGridConfigs.getIndicatorGridLandscapeConfig, _indicatorGridConfigs.getIndicatorGridPortraitConfig).call(null, type);
}

},{"./grid/background-grid-configs":124,"./grid/cta-3pp-grid-configs":125,"./grid/cta-bottom-layer-gird-config":126,"./grid/cta-container-grid-configs":127,"./grid/cta-embedded-grid-configs":128,"./grid/cta-page-peel-gird-config":129,"./grid/cta-standard-lose-grid-configs":130,"./grid/cta-standard-win-grid-configs":131,"./grid/foreground-grid-configs":132,"./grid/game-grid-configs":133,"./grid/indicator-grid-configs":134,"./grid/main-grid-configs":135,"./grid/tutorial-grid-config":136,"./grid/tutorial-sequence-grid-config":137,"./grid/ui-grid-configs":138}],124:[function(require,module,exports){
'use strict';
...
},{"@armathai/phaser2-grid":286}],125:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getCTA3PPGridLandscapeConfig = getCTA3PPGridLandscapeConfig;
exports.getCTA3PPGridPortraitConfig = getCTA3PPGridPortraitConfig;

var _phaser2Grid = require('@armathai/phaser2-grid');

function getCTA3PPGridLandscapeConfig() {
  return {
...
function getCTA3PPGridPortraitConfig() {
  return {
    // debug: { color: 0x4bdbd4 },
    name: 'cta',
    cells: [{
...
},{"@armathai/phaser2-grid":286}],126:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getCTABottomLayerGridLandscapeConfig = getCTABottomLayerGridLandscapeConfig;
exports.getCTABottomLayerGridPortraitConfig = getCTABottomLayerGridPortraitConfig;

var _phaser2Grid = require('@armathai/phaser2-grid');

function getCTABottomLayerGridLandscapeConfig() {
  return {
    // debug: { color: 0x4bdbd4 },
...
function getCTABottomLayerGridPortraitConfig() {
  return {
    // debug: { color: 0x4bdbd4 },
    name: 'cta_bottom_layer',
    cells: [{
...
},{"@armathai/phaser2-grid":286}],127:[function(require,module,exports){
'use strict';
...
},{"@armathai/phaser2-grid":286}],129:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getPagePeelCTAGridLandscapeConfig = getPagePeelCTAGridLandscapeConfig;
exports.getPagePeelCTAGridPortraitConfig = getPagePeelCTAGridPortraitConfig;

var _phaser2Grid = require('@armathai/phaser2-grid');

function getPagePeelCTAGridLandscapeConfig() {
  return {
    // debug: { color: 0x4bdbd4 },
    name: 'cta_page_peel',
    cells: [{
...
function getPagePeelCTAGridPortraitConfig() {
  return {
    // debug: { color: 0x4bdbd4 },
    name: 'cta_page_peel',
    cells: [{
...
},{"@armathai/phaser2-grid":286}],130:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getCTAStandardLoseGridLandscapeConfig = getCTAStandardLoseGridLandscapeConfig;
exports.getCTAStandardLoseGridPortraitConfig = getCTAStandardLoseGridPortraitConfig;

var _phaser2Grid = require('@armathai/phaser2-grid');

function getCTAStandardLoseGridLandscapeConfig() {
  return {
    // debug: { color: 0x4bdbd4 },
    name: 'cta',
    cells: [{
...
function getCTAStandardLoseGridPortraitConfig() {
  return {
    // debug: { color: 0x4bdbd4 },
    name: 'cta',
    cells: [{
...
},{"@armathai/phaser2-grid":286}],131:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getCTAStandardWinGridLandscapeConfig = getCTAStandardWinGridLandscapeConfig;
exports.getCTAStandardWinGridPortraitConfig = getCTAStandardWinGridPortraitConfig;

var _phaser2Grid = require('@armathai/phaser2-grid');

function getCTAStandardWinGridLandscapeConfig() {
  return {
    // debug: { color: 0x4bdbd4 },
    name: 'cta',
    cells: [{
...
function getCTAStandardWinGridPortraitConfig() {
  return {
    // debug: { color: 0x4bdbd4 },
    name: 'cta',
    cells: [{
...
},{"@armathai/phaser2-grid":286}],132:[function(require,module,exports){
'use strict';
...
},{"@armathai/phaser2-grid":286}],134:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getIndicatorGridLandscapeConfig = getIndicatorGridLandscapeConfig;
exports.getIndicatorGridPortraitConfig = getIndicatorGridPortraitConfig;
...
function getIndicatorGridLandscapeConfig(type) {
  var offset = 0;
  switch (type) {
    case 'icon_text':
      offset = 60;
  ...
  var indicatorFrameTileTexture = (0, _utils.searchAtlasByFrame)((0, _imageConfigs.getIndicatorFrameTileConfig)().frame);
  var indicatorFrameRectangleTexture = (0, _utils.searchAtlasByFrame)((0, _imageConfigs.getIndicatorFrameRectangleConfig)().frame);

  var _CI_API$game$cache$ge = CI_API.game.cache.getFrameByName(indicatorFrameTileTexture.key, indicatorFrameTileTexture.frame),
      indicatorFrameTileSourceSizeH = _CI_API$game$cache$ge.sourceSizeH;

  var _CI_API$game$cache$ge2 = CI_API.game.cache.getFrameByName(indicatorFrameRectangleTexture.key, indicatorFrameRectangleTexture.frame),
      indicatorFrameRectangleTextureSourceSizeW = _CI_API$game$cache$ge2.sourceSizeW,
      indicatorFrameRectangleTextureSourceSizeH = _CI_API$game$cache$ge2.sourceSizeH;
...
function getIndicatorGridPortraitConfig(type) {
  var offset = 0;
  switch (type) {
    case 'icon_text':
      offset = 70;
  ...
  var _CI_API$game$cache$ge3 = CI_API.game.cache.getFrameByName(indicatorFrameTileTexture.key, indicatorFrameTileTexture.frame),
      indicatorFrameTileSourceSizeH = _CI_API$game$cache$ge3.sourceSizeH;

  var _CI_API$game$cache$ge4 = CI_API.game.cache.getFrameByName(indicatorFrameRectangleTexture.key, indicatorFrameRectangleTexture.frame),
      indicatorFrameRectangleTextureSourceSizeW = _CI_API$game$cache$ge4.sourceSizeW,
      indicatorFrameRectangleTextureSourceSizeH = _CI_API$game$cache$ge4.sourceSizeH;
...
},{"../../utils":266,"../image-configs":139,"@armathai/phaser2-grid":286}],135:[function(require,module,exports){
'use strict';
...
},{"../../utils":266,"@armathai/phaser2-grid":286}],136:[function(require,module,exports){
'use strict';
...
},{"@armathai/phaser2-grid":286}],137:[function(require,module,exports){
'use strict';
...
function getUIGridPortraitConfig() {
  var buttonsY = (0, _utils.isSquareLikeScreen)() ? 0.55 : 0.6;
  return {
    // debug: { color: 0x4287f5 },
    name: 'ui',
    cells: [{
      ...
      name: 'points',
      bounds: { x: 0, y: 0.075, width: 1, height: (0, _utils.isNarrowScreen)() ? 0.075 : 0.1 }
    }]
  };
}

},{"../../utils":266}],139:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getCTAPopupBgImageConfig = getCTAPopupBgImageConfig;
exports.getLogoImageConfig = getLogoImageConfig;
exports.getBoardBgTileImageConfig = getBoardBgTileImageConfig;
exports.getPlayableIconConfig = getPlayableIconConfig;
exports.getIndicatorFrameCircleConfig = getIndicatorFrameCircleConfig;
exports.getIndicatorFrameTileConfig = getIndicatorFrameTileConfig;
exports.getIndicatorFrameRectangleConfig = getIndicatorFrameRectangleConfig;
exports.getIndicatorLoadingCircleConfig = getIndicatorLoadingCircleConfig;
exports.getSnakePartImageConfig = getSnakePartImageConfig;
exports.getPowerUpImageConfig = getPowerUpImageConfig;
exports.getPowerUpGlowImageConfig = getPowerUpGlowImageConfig;
exports.getHandImageConfig = getHandImageConfig;
function getCTAPopupBgImageConfig() {
  return {
...
function getPlayableIconConfig() {
  return {
    frame: 'indicator/icon_playable.png'
  };
}

function getIndicatorFrameCircleConfig() {
  return {
    frame: 'indicator/indicator_frame_circle.png'
  };
}

function getIndicatorFrameTileConfig() {
  return {
    frame: 'indicator/indicator_frame_long_tile.png'
  };
}

function getIndicatorFrameRectangleConfig() {
  return {
    frame: 'indicator/indicator_frame_rectangle.png'
  };
}

function getIndicatorLoadingCircleConfig() {
  return {
    frame: 'indicator/loading_circle.png'
  };
}

function getSnakePartImageConfig(skin, part) {
  return {
    frame: 'snakes/' + skin + '/' + part + '.png'
  };
}

function getPowerUpImageConfig() {
  return {
    frame: 'ui/power_up.png'
  };
}

function getPowerUpGlowImageConfig() {
  return {
...
var _onJoystickPressedCommand = require('../commands/ad/joystick/on-joystick-pressed-command');

var _onJoystickReleasedCommand = require('../commands/ad/joystick/on-joystick-released-command');

var _onJoystickStateUpdate = require('../commands/ad/joystick/on-joystick-state-update');

var _onPowerUpPressCommand = require('../commands/ad/power_up/on-power-up-press-command');

var _onPowerUpReleaseCommand = require('../commands/ad/power_up/on-power-up-release-command');
...
var _onTutorialHideCompleteCommand = require('../commands/ad/tutorial/on-tutorial-hide-complete-command');
...
var _onFoodStateUpdateCommand = require('../commands/food/on-food-state-update-command');

var _indicatorVisibleUpdateCommand = require('../commands/indicator/indicator-visible-update-command');

var _onScoreUpdateCommand = require('../commands/player/on-score-update-command');

var _onSnakeEnergyUpdateCommand = require('../commands/snake/on-snake-energy-update-command');

var _onSnakeStateUpdateCommand = require('../commands/snake/on-snake-state-update-command');

var _onFirstClickOnControllerCommand = require('../commands/view/on-first-click-on-controller-command');

var _onFragmentsDropCommand = require('../commands/view/on-fragments-drop-command');

var _onGameViewInputDown = require('../commands/view/on-game-view-input-down');

var _onGameViewInputUp = require('../commands/view/on-game-view-input-up');

var _onSnakeAbleToBoostUpdateCommand = require('../commands/view/on-snake-able-to-boost-update-command');

var _onSnakeBitesCommand = require('../commands/view/on-snake-bites-command');

var _onSnakeCollideWithBorderCommand = require('../commands/view/on-snake-collide-with-border-command');

var _onSnakeEatFoodCommand = require('../commands/view/on-snake-eat-food-command');

var _onSnakeExhaustCommand = require('../commands/view/on-snake-exhaust-command');

var _onSnakePowerUpUpdateCommand = require('../commands/view/on-snake-power-up-update-command');
...
var playCommands = exports.playCommands = Object.freeze([{
  ...
  event: _viewEvents.ViewEvents.TutorialView.HideComplete,
  command: _onTutorialHideCompleteCommand.onTutorialHideCompleteCommand
}, {
  ...
  event: _modelEvents.ModelEvents.IndicatorModel.VisibleUpdate,
  command: _indicatorVisibleUpdateCommand.onIndicatorVisibleUpdateCommand
}, {
  event: _viewEvents.ViewEvents.BoardView.SnakeCollideWithBorder,
  command: _onSnakeCollideWithBorderCommand.onSnakeCollideWithBorderCommand
}, {
  event: _viewEvents.ViewEvents.GameView.FirstClickOnController,
  command: _onFirstClickOnControllerCommand.onFirstClickOnControllerCommand
}, {
  event: _modelEvents.ModelEvents.SnakeModel.StateUpdate,
  command: _onSnakeStateUpdateCommand.onSnakeStateUpdateCommand
}, {
  event: _viewEvents.ViewEvents.BoardView.SnakeBites,
  command: _onSnakeBitesCommand.onSnakeBitesCommand
}, {
  event: _viewEvents.ViewEvents.BoardView.SnakeEatFood,
  command: _onSnakeEatFoodCommand.onSnakeEatFoodCommand
}, {
  event: _modelEvents.ModelEvents.FoodModel.StateUpdate,
  command: _onFoodStateUpdateCommand.onFoodStateUpdateCommand
}, {
  event: _modelEvents.ModelEvents.PlayerModel.ScoreUpdate,
  command: _onScoreUpdateCommand.onScoreUpdateCommand
}, {
  event: _viewEvents.ViewEvents.PowerUpView.Pressed,
  command: _onPowerUpPressCommand.onPowerUpPressCommand
}, {
  event: _viewEvents.ViewEvents.PowerUpView.Released,
  command: _onPowerUpReleaseCommand.onPowerUpReleaseCommand
}, {
  event: _modelEvents.ModelEvents.TimerModel.CompleteUpdate,
  command: _timerCompleteUpdateCommand.timerCompleteUpdateCommand
}, {
  event: _modelEvents.ModelEvents.SnakeModel.AbleToBoostUpdate,
  command: _onSnakeAbleToBoostUpdateCommand.onSnakeAbleToBoostUpdateCommand
}, {
  event: _modelEvents.ModelEvents.SnakeModel.PowerUpUpdate,
  command: _onSnakePowerUpUpdateCommand.onSnakePowerUpUpdateCommand
}, {
  event: _viewEvents.ViewEvents.BoardView.SnakeExhaust,
  command: _onSnakeExhaustCommand.onSnakeExhaustCommand
}, {
  event: _viewEvents.ViewEvents.JoystickView.Pressed,
  command: _onJoystickPressedCommand.onJoystickPressedCommand
}, {
  event: _viewEvents.ViewEvents.JoystickView.Released,
  command: _onJoystickReleasedCommand.onJoystickReleasedCommand
}, {
  event: _modelEvents.ModelEvents.JoystickModel.StateUpdate,
  command: _onJoystickStateUpdate.onJoystickStateUpdate
}, {
  event: _viewEvents.ViewEvents.GameView.InputDown,
  command: _onGameViewInputDown.onGameViewInputDown
}, {
  event: _viewEvents.ViewEvents.GameView.InputUp,
  command: _onGameViewInputUp.onGameViewInputUp
}, {
  event: _viewEvents.ViewEvents.BoardView.FragmentsDrop,
  command: _onFragmentsDropCommand.onFragmentsDropCommand
}, {
  event: _modelEvents.ModelEvents.SnakeModel.EnergyUpdate,
  command: _onSnakeEnergyUpdateCommand.onSnakeEnergyUpdateCommand
}]);

},{"../commands/ad/cta/cta-previsible-update-command":5,"../commands/ad/joystick/on-joystick-pressed-command":21,"../commands/ad/joystick/on-joystick-released-command":22,"../commands/ad/joystick/on-joystick-state-update":23,"../commands/ad/power_up/on-power-up-press-command":32,"../commands/ad/power_up/on-power-up-release-command":33,"../commands/ad/timer/timer-complete-update-command":45,"../commands/ad/tutorial/on-tutorial-complete-command":51,"../commands/ad/tutorial/on-tutorial-hide-complete-command":52,"../commands/ad/tutorial/on-tutorial-sequence-complete-command":53,"../commands/ad/tutorial/on-tutorial-skip-command":54,"../commands/ad/tutorial/tutorial-screen-click-command":58,"../commands/ad/tutorial/tutorial-sequence-view-complete-command":59,"../commands/food/on-food-state-update-command":62,"../commands/indicator/indicator-visible-update-command":75,"../commands/player/on-score-update-command":83,"../commands/snake/on-snake-energy-update-command":91,"../commands/snake/on-snake-state-update-command":92,"../commands/view/on-first-click-on-controller-command":107,"../commands/view/on-fragments-drop-command":108,"../commands/view/on-game-view-input-down":109,"../commands/view/on-game-view-input-up":110,"../commands/view/on-snake-able-to-boost-update-command":112,"../commands/view/on-snake-bites-command":113,"../commands/view/on-snake-collide-with-border-command":114,"../commands/view/on-snake-eat-food-command":115,"../commands/view/on-snake-exhaust-command":116,"../commands/view/on-snake-power-up-update-command":117,"../events/model-events":151,"../events/view-events":152}],141:[function(require,module,exports){
'use strict';
...
exports.getBoardBorderHorizontalLineNinePatchConfig = getBoardBorderHorizontalLineNinePatchConfig;
...
exports.getNewSkinBubblePatchConfig = getNewSkinBubblePatchConfig;

var _constants = require('../constants');

var tutorialBg = 'ui/tutorial_bubble.png';
var greenBtnBig = 'ui/green_btn_big.png';
var greenBtnSmall = 'ui/green_btn_small.png';
var blueBtn = 'ui/blue_btn.png';
var skinBubble = 'cta/new_skin_bubble.png';
var border = 'bg/borders.png';

// TUTORIAL
function getBoardBorderHorizontalLineNinePatchConfig() {
  var width = _constants.boardDimensions.width;

  return {
    width: width + 2 * _constants.boardBorderOffset,
    height: 32,
    frame: border,
    anchor: { x: 0, y: 0 }
  };
...
function getNewSkinBubblePatchConfig() {
  return {
    width: 450,
    height: 255,
    frame: skinBubble
...
},{"../constants":146}],142:[function(require,module,exports){
'use strict';
...
exports.getCTAWinConfettiEmitterConfig = getCTAWinConfettiEmitterConfig;
var sparkle = 'sparkle';
var ctaConfetti = 'ctaConfetti';
...
function getCTAWinConfettiParticlesConfig() {
  return {
    ...
    data: {
      lifespan: 2000,
      frame: ['confetti/01.png', 'confetti/02.png', 'confetti/03.png', 'confetti/04.png', 'confetti/05.png', 'confetti/06.png'],
      scale: {
        initial: 0,
        value: 1,
        control: [{ x: 0, y: 0.5 }, { x: 0.3, y: 1 }, { x: 1, y: 0 }]
...
var particles = exports.particles = [getSparkleParticlesConfig(), getCTAWinConfettiParticlesConfig()];
...
function getCTAWinConfettiEmitterConfig(parent, bounds) {
  var x = bounds.x,
      y = bounds.y,
      width = bounds.width,
...
exports.getSnakeSpineConfig = getSnakeSpineConfig;
...
function getSnakeSpineConfig(x, y) {
  return {
...
exports.getLosePopupTextConfig = getLosePopupTextConfig;
exports.getWinPopupTextConfig = getWinPopupTextConfig;
exports.getEmbeddedPopupTextConfig = getEmbeddedPopupTextConfig;
exports.get3PPPopupTextConfig = get3PPPopupTextConfig;
exports.getIndicatorTextConfig = getIndicatorTextConfig;
exports.getTimerTextConfig = getTimerTextConfig;
exports.getPointsTextConfig = getPointsTextConfig;
exports.getSnakeNameTextConfig = getSnakeNameTextConfig;
...
function getLosePopupTextConfig() {
  return {
    text: 'You Lost',
    style: {
      font: _constants.FONT1,
...
function getWinPopupTextConfig() {
  return {
...
function getEmbeddedPopupTextConfig() {
  return {
    text: 'Keep growing!',
    style: {
      font: _constants.FONT1,
...
function get3PPPopupTextConfig() {
  return {
    text: 'NEW SKIN',
    style: {
      font: _constants.FONT1,
...
// INDICATOR
function getIndicatorTextConfig(wordWrap, wordWrapWidth) {
  var x = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
  var y = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
  var fontSize = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 23;
...
// SNAKE NAME
function getSnakeNameTextConfig(text) {
  return {
    text: text,
    style: {
      font: _constants.FONT1,
...
},{"../constants":146}],145:[function(require,module,exports){
'use strict';
...
function getTutorialConfig() {
  var _CI_API$Globals$PARAM = CI_API.Globals.PARAMS,
      joystick = _CI_API$Globals$PARAM.joystick_enabled,
      tutorialTime = _CI_API$Globals$PARAM.tutorial_time;


  return [{ text: joystick ? 'Tutorial Text 1' : 'Tutorial Text 2', duration: -1, clickToComplete: true }, { text: 'Tutorial Text 3', duration: tutorialTime, clickToComplete: false }];
}
...
var FONT1 = exports.FONT1 = 'Asap-Bold';
var FONT2 = exports.FONT2 = 'Roboto-BlackItalic';
...
var IndicatorType = exports.IndicatorType = Object.freeze({
  Round: 'Round',
  RoundedRect: 'RoundedRect',
  Full: 'Full'
});

var SnakePartType = exports.SnakePartType = Object.freeze({
  Head: 'head',
  Body: 'body',
  Tail: 'tail'
});

var SnakeSkin = exports.SnakeSkin = Object.freeze({
  WhiteCat: 'white_cat',
  Dog: 'dog',
  Fire: 'fire',
  RoboTrex: 'robotrex',
...
var SkinColors = exports.SkinColors = Object.freeze({
  WhiteCat: '0xffffff',
  Dog: '0xf8c075',
  Fire: '0xf99626',
  RoboTrex: '0x627380',
...
var SnakeState = exports.SnakeState = Object.freeze({
  Unknown: 'unknown',
  Idle: 'idle',
  Dead: 'dead'
});

var FoodState = exports.FoodState = Object.freeze({
  Unknown: 'unknown',
  Idle: 'idle',
  Eaten: 'eaten'
});

var FoodType = exports.FoodType = Object.freeze({
  Regular: 'regular',
  Super: 'super'
});
...
var PlayerSpeed = exports.PlayerSpeed = Object.freeze({
  slow: 5,
  medium: 6,
  fast: 7
});

var EnemySpeed = exports.EnemySpeed = Object.freeze({
  slow: 5,
  medium: 6,
  fast: 7
});

var PowerUpState = exports.PowerUpState = Object.freeze({
  Unknown: 'unknown',
  Disable: 'disable',
  Enable: 'enable',
  Pressed: 'pressed'
...
var JoystickState = exports.JoystickState = Object.freeze({
  Unknown: 'unknown',
  Disable: 'disable',
  Enable: 'enable',
  Pressed: 'pressed'
...
var boardDimensions = exports.boardDimensions = Object.freeze({
  width: 1600,
  height: 1600
});

var foodWeight = exports.foodWeight = Object.freeze({
  regular: 1,
  super: 10
});

var boardBorderOffset = exports.boardBorderOffset = 26;
...
},{"webfontloader":290}],148:[function(require,module,exports){
'use strict';
...
},{"./lu/layout-utils-compact":149,"./lu/layout-utils-general":150}],149:[function(require,module,exports){
'use strict';
...
},{"../../constants":146}],154:[function(require,module,exports){
'use strict';
...
},{"../../models/store":215}],156:[function(require,module,exports){
'use strict';
...
},{"../../models/store":215}],157:[function(require,module,exports){
'use strict';
...
},{"../../models/store":215}],158:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.gameHasBeenRetriedGuard = gameHasBeenRetriedGuard;

var _store = require('../../models/store');

function gameHasBeenRetriedGuard() {
  return _store.store.ad.retries !== CI_API.Globals.PARAMS.retries;
}

},{"../../models/store":215}],159:[function(require,module,exports){
'use strict';
...
},{"../../models/store":215}],160:[function(require,module,exports){
"use strict";
...
},{"../../models/store":215}],162:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.joystickModelGuard = joystickModelGuard;

var _store = require('../../models/store');

function joystickModelGuard() {
  return _store.store.ad.joystick;
}

},{"../../models/store":215}],163:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.joystickParamGuard = joystickParamGuard;
function joystickParamGuard() {
...
exports.joystickStateEnableGuard = joystickStateEnableGuard;

var _constants = require('../../constants');

var _store = require('../../models/store');

function joystickStateEnableGuard() {
  return _store.store.ad.joystick.state === _constants.JoystickState.Enable;
}

},{"../../constants":146,"../../models/store":215}],165:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.joystickStatePressedGuard = joystickStatePressedGuard;

var _constants = require('../../constants');

var _store = require('../../models/store');

function joystickStatePressedGuard() {
  return _store.store.ad.joystick.state === _constants.JoystickState.Pressed;
}

},{"../../constants":146,"../../models/store":215}],166:[function(require,module,exports){
'use strict';
...
},{"../../models/store":215}],167:[function(require,module,exports){
"use strict";
...
exports.playableIndicatorGuard = playableIndicatorGuard;

var _store = require('../../models/store');

function playableIndicatorGuard() {
  return _store.store.ad.playableIndicator;
}

},{"../../models/store":215}],169:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.playableIndicatorParamGuard = playableIndicatorParamGuard;
function playableIndicatorParamGuard() {
...
exports.playableIndicatorVisibleGuard = playableIndicatorVisibleGuard;

var _store = require('../../models/store');

function playableIndicatorVisibleGuard() {
  return !_store.store.ad.playableIndicator.visible;
}

},{"../../models/store":215}],171:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.powerUpModelGuard = powerUpModelGuard;

var _store = require('../../models/store');

function powerUpModelGuard() {
  return _store.store.ad.powerUp;
}

},{"../../models/store":215}],172:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.powerUpParamGuard = powerUpParamGuard;
function powerUpParamGuard() {
...
},{"../../models/store":215}],174:[function(require,module,exports){
"use strict";
...
},{"../../models/store":215}],176:[function(require,module,exports){
'use strict';
...
},{"../../models/store":215}],177:[function(require,module,exports){
"use strict";
...
function boardIdleStateGuard() {
  var state = _store.store.game.boardModel.state;

  return state === _constants.BoardState.Idle;
}

},{"../../constants":146,"../../models/store":215}],179:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.boardUnknownStateGuard = boardUnknownStateGuard;

var _constants = require('../../constants');

var _store = require('../../models/store');

function boardUnknownStateGuard() {
  var state = _store.store.game.boardModel.state;

  return state === _constants.BoardState.Unknown;
}

},{"../../constants":146,"../../models/store":215}],180:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.foodEatenGuard = foodEatenGuard;

var _constants = require('../../constants');

var _store = require('../../models/store');

function foodEatenGuard(uuid) {
  var food = _store.store.game.boardModel.getFoodByUuid(uuid);
  return food && food.state === _constants.FoodState.Eaten;
}

},{"../../constants":146,"../../models/store":215}],181:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.hasEnoughEnergyForPowerUpGuard = hasEnoughEnergyForPowerUpGuard;

var _store = require('../../models/store');

function hasEnoughEnergyForPowerUpGuard(uuid) {
  var snake = _store.store.game.boardModel.getSnakeByUuid(uuid);
  return snake.energy > 15;
}

},{"../../models/store":215}],182:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.isPlayerSnakeGuard = isPlayerSnakeGuard;

var _store = require('../../models/store');

function isPlayerSnakeGuard(uuid) {
  var _store$game$boardMode = _store.store.game.boardModel.getSnakeByUuid(uuid),
      isPlayer = _store$game$boardMode.isPlayer;

  return isPlayer;
}

},{"../../models/store":215}],183:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.snakeDeadGuard = snakeDeadGuard;

var _constants = require('../../constants');

var _store = require('../../models/store');

function snakeDeadGuard(uuid) {
  var snake = _store.store.game.boardModel.getSnakeByUuid(uuid);
  return snake.state === _constants.SnakeState.Dead;
}

},{"../../constants":146,"../../models/store":215}],184:[function(require,module,exports){
'use strict';
...
},{"../../models/store":215}],185:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.gamePointerExistGuard = gamePointerExistGuard;

var _store = require('../../models/store');

function gamePointerExistGuard() {
  return _store.store.game.pointer;
}

},{"../../models/store":215}],186:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.scoreToCtaReachedGuard = scoreToCtaReachedGuard;

var _store = require('../../models/store');

function scoreToCtaReachedGuard() {
  return _store.store.player.score >= CI_API.Globals.PARAMS.score_to_cta;
}

},{"../../models/store":215}],187:[function(require,module,exports){
'use strict';
...
},{"../../models/store":215}],188:[function(require,module,exports){
"use strict";
...
},{"../../models/store":215}],190:[function(require,module,exports){
"use strict";
...
},{"./commands/startup-command":101,"./display/font-loader":147,"./display/layout-utils":148,"./kernel/globals":192,"./lib/particle-storm":194,"./objects/cta/cta-view":225,"./states/game-state":255,"./states/preloader-state":256,"./strings":257}],196:[function(require,module,exports){
'use strict';
...
var _indicatorModel = require('./indicator-model');

var _joystickModel = require('./joystick-model');

var _loadModel = require('./load-model');

var _persistentCtaModel = require('./persistent-cta-model');

var _powerUpModel = require('./power-up-model');
...
var AdModel = exports.AdModel = function (_ObservableModel) {
  ...
  _createClass(AdModel, [{
    ...
    key: 'initializePowerUpModel',
    value: function initializePowerUpModel() {
      this._powerUp = new _powerUpModel.PowerUpModel();
      this._powerUp.initialize();
    }
  }, {
    key: 'destroyPowerUpModel',
    value: function destroyPowerUpModel() {
    ...
    key: 'initializeJoystickModel',
    value: function initializeJoystickModel() {
      this._joystick = new _joystickModel.JoystickModel();
      this._joystick.initialize();
    }
  }, {
    key: 'destroyJoystickModel',
    value: function destroyJoystickModel() {
    ...
    key: 'initializePlayableIndicator',
    value: function initializePlayableIndicator() {
      this._playableIndicator = new _indicatorModel.IndicatorModel();
      this._playableIndicator.initialize();
    }
  }, {
    key: 'destroyPlayableIndicatorModel',
    value: function destroyPlayableIndicatorModel() {
...
},{"../../constants":146,"../observable-model":213,"./cta-model":197,"./hint-model":198,"./indicator-model":199,"./joystick-model":200,"./load-model":201,"./persistent-cta-model":202,"./power-up-model":203,"./sound-model":204,"./timer-model":205,"./tutorial-model":206}],197:[function(require,module,exports){
'use strict';
...
var ctaTypesDependsOnReason = (_ctaTypesDependsOnRea = {}, _defineProperty(_ctaTypesDependsOnRea, _constants.GameOverReasons.Idled, 'standard'), _defineProperty(_ctaTypesDependsOnRea, _constants.GameOverReasons.ScoreToCtaReached, 'standard'), _ctaTypesDependsOnRea);
...
},{"../../constants":146,"../../utils":266,"../observable-model":213}],198:[function(require,module,exports){
'use strict';
...
},{"../../utils":266,"../observable-model":213}],199:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.IndicatorModel = undefined;
...
var IndicatorModel = exports.IndicatorModel = function (_ObservableModel) {
  _inherits(IndicatorModel, _ObservableModel);

  function IndicatorModel() {
    _classCallCheck(this, IndicatorModel);

    var _this = _possibleConstructorReturn(this, (IndicatorModel.__proto__ || Object.getPrototypeOf(IndicatorModel)).call(this, 'IndicatorModel'));

    _this._visible = false;

    _this.makeObservable('_visible');
    return _this;
  }

  _createClass(IndicatorModel, [{
    key: 'initialize',
    value: function initialize() {
      this._visible = true;
    ...
    value: function destroy() {
      ...
      this._visible = false;
      _get(IndicatorModel.prototype.__proto__ || Object.getPrototypeOf(IndicatorModel.prototype), 'destroy', this).call(this);
    }
  }, {
    ...
    value: function _startVisibilityTimer() {
      ...
      this._visibilityTimer = (0, _utils.delayRunnable)(CI_API.Globals.PARAMS.playable_indicator_duration, function () {
        _this2.destroy();
      });
    }
  }, {
...
},{"../../utils":266,"../observable-model":213}],200:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.JoystickModel = undefined;
...
var JoystickModel = exports.JoystickModel = function (_ObservableModel) {
  _inherits(JoystickModel, _ObservableModel);

  function JoystickModel() {
    _classCallCheck(this, JoystickModel);

    var _this = _possibleConstructorReturn(this, (JoystickModel.__proto__ || Object.getPrototypeOf(JoystickModel)).call(this, 'JoystickModel'));

    _this._state = _constants.JoystickState.Unknown;
    _this.makeObservable();
    return _this;
  }

  _createClass(JoystickModel, [{
    key: 'destroy',
    value: function destroy() {
      this._state = _constants.JoystickState.Disable;

      _get(JoystickModel.prototype.__proto__ || Object.getPrototypeOf(JoystickModel.prototype), 'destroy', this).call(this);
    }
  }, {
    key: 'initialize',
    value: function initialize() {
      this._state = _constants.JoystickState.Enable;
    }
  }, {
    key: 'state',
    get: function get() {
...
},{"../../constants":146,"../observable-model":213}],201:[function(require,module,exports){
'use strict';
...
},{"../observable-model":213}],202:[function(require,module,exports){
'use strict';
...
},{"../observable-model":213}],203:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.PowerUpModel = undefined;
...
var PowerUpModel = exports.PowerUpModel = function (_ObservableModel) {
  _inherits(PowerUpModel, _ObservableModel);

  function PowerUpModel() {
    _classCallCheck(this, PowerUpModel);

    var _this = _possibleConstructorReturn(this, (PowerUpModel.__proto__ || Object.getPrototypeOf(PowerUpModel)).call(this, 'PowerUpModel'));

    _this._state = _constants.PowerUpState.Unknown;
    _this.makeObservable();
    return _this;
  }

  _createClass(PowerUpModel, [{
    key: 'destroy',
    value: function destroy() {
      this._state = _constants.PowerUpState.Disable;

      _get(PowerUpModel.prototype.__proto__ || Object.getPrototypeOf(PowerUpModel.prototype), 'destroy', this).call(this);
    }
  }, {
    key: 'initialize',
    value: function initialize() {
...
},{"../../constants":146,"../observable-model":213}],204:[function(require,module,exports){
'use strict';
...
},{"../../constants":146,"../observable-model":213}],205:[function(require,module,exports){
'use strict';
...
},{"../../utils":266,"../observable-model":213}],206:[function(require,module,exports){
'use strict';
...
},{"../../configs/tutorial-config":145,"../../utils":266,"../observable-model":213,"./tutorial-sequence-model":207}],207:[function(require,module,exports){
'use strict';
...
},{"../observable-model":213}],208:[function(require,module,exports){
'use strict';
...
var _foodModel = require('./food-model');

var _snakeModel = require('./snake/snake-model');
...
var BoardModel = exports.BoardModel = function (_ObservableModel) {
  ...
  function BoardModel() {
    ...
    _this._snakes = [];
    _this._foods = null;
    _this._playerSnake = null;
    _this._foodProductionRunnable = null;
  ...
  _createClass(BoardModel, [{
    key: 'getSnakeByUuid',
    value: function getSnakeByUuid(uuid) {
      return this._snakes.find(function (s) {
        return s.uuid === uuid;
      });
    }
  }, {
    key: 'getFoodByUuid',
    value: function getFoodByUuid(uuid) {
      return this._foods.find(function (f) {
        return f.uuid === uuid;
      });
    }
    ...
    key: 'makeFragments',
    value: function makeFragments(snake) {
      snake.makeFragments();
    }
  }, {
    key: 'makeFood',
    value: function makeFood(data) {
      var food = new _foodModel.FoodModel(data);
      food.initialize();
      this._foods = [].concat(_toConsumableArray(this._foods), [food]);
    }
  }, {
    key: 'removeSnake',
    value: function removeSnake(uuid) {
      var snake = this.getSnakeByUuid(uuid);
      snake.destroy();
      this._snakes = (0, _difference.difference)(this._snakes, [snake]);
    }
  }, {
    key: 'removeFood',
    value: function removeFood(uuid) {
      var food = this.getFoodByUuid(uuid);
      this._foods = (0, _difference.difference)(this._foods, [food]);
    }
  }, {
    key: 'destroy',
    value: function destroy() {
      (0, _utils.removeRunnable)(this._foodProductionRunnable);
    }
  }, {
    key: 'initialize',
    value: function initialize() {
      var _sample = (0, _sample2.sample)((0, _boardConfig.getBoardConfig)()),
          snakes = _sample.snakes,
          player = _sample.player;

      var count = CI_API.Globals.PARAMS.number_of_enemies;
      (0, _shuffle.shuffle)(snakes);
      this._snakes = this._createSnakes([player].concat(_toConsumableArray(snakes.slice(0, count))));
      this._foods = this._createFoods();
      this._state = _constants.BoardState.Paused;
      this._startProduceFood();

      this._snakes.forEach(function (s) {
        s.state = _constants.SnakeState.Idle;
      });
    }
  }, {
    key: '_startProduceFood',
    value: function _startProduceFood() {
      var _this2 = this;

      this._foodProductionRunnable = (0, _utils.loopRunnable)(2000, function () {
        var possibleCount = 100 - _this2._foods.length;
        if (possibleCount > 0) {
          _this2._foods = [].concat(_toConsumableArray(_this2._foods), _toConsumableArray(_this2._createFoods(Math.min(5, possibleCount))));
        }
      });
    }
    ...
    key: '_createSnakes',
    value: function _createSnakes(snakesConfig) {
      return snakesConfig.map(function (config) {
        var snake = new _snakeModel.SnakeModel(config);
        snake.initialize();
    ...
    key: 'enemies',
    get: function get() {
      return this._snakes.filter(function (s) {
        return !s.isPlayer;
      });
    }
  }, {
...
},{"../../../configs/board-config":121,"../../../constants":146,"../../../utils":266,"../../../utils/array/difference":258,"../../../utils/array/sample":260,"../../../utils/array/shuffle":261,"../../observable-model":213,"./food-model":209,"./snake/snake-model":210}],209:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.FoodModel = undefined;
...
var FoodModel = exports.FoodModel = function (_ObservableModel) {
  _inherits(FoodModel, _ObservableModel);
  ...
  function FoodModel() {
    ...
    var _this = _possibleConstructorReturn(this, (FoodModel.__proto__ || Object.getPrototypeOf(FoodModel)).call(this, 'FoodModel'));

    var width = _constants.boardDimensions.width,
        height = _constants.boardDimensions.height;


    _this._config = Object.assign({
      skin: (0, _sample.sample)((0, _objectKeys.objectKeys)(_constants.SnakeSkin)),
      bodyPart: null,
      angle: 0,
      position: { x: (0, _randomReal.randomReal)(10, width - 10), y: (0, _randomReal.randomReal)(10, height - 10) },
      type: _constants.FoodType.Regular
    }, config);

    _this._state = _constants.FoodState.Unknown;
  ...
  _createClass(FoodModel, [{
    key: 'initialize',
    value: function initialize() {
      this._state = _constants.FoodState.Idle;
    }
  }, {
    key: 'state',
    get: function get() {
...
},{"../../../constants":146,"../../../utils/array/sample":260,"../../../utils/number/random-real":268,"../../../utils/object/object-keys":269,"../../observable-model":213}],210:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.SnakeModel = undefined;
...
var _snakePartModel = require('./snake-part-model');
...
function getSnakeSkinKey(skin) {
  ...
  for (var key in _constants.SnakeSkin) {
    if (Object.hasOwnProperty.call(_constants.SnakeSkin, key)) {
      var element = _constants.SnakeSkin[key];
      if (element === skin) {
        k = key;
      }
    }
...
var defaultLength = 6;
var headConfig = { type: _constants.SnakePartType.Head };
var bodyConfig = { type: _constants.SnakePartType.Body };
var tailConfig = { type: _constants.SnakePartType.Tail };
var emptySnakeConfig = [headConfig, tailConfig];

var SnakeModel = exports.SnakeModel = function (_ObservableModel) {
  _inherits(SnakeModel, _ObservableModel);

  function SnakeModel(config) {
    _classCallCheck(this, SnakeModel);

    var _this = _possibleConstructorReturn(this, (SnakeModel.__proto__ || Object.getPrototypeOf(SnakeModel)).call(this, 'SnakeModel'));

    _this._state = _constants.SnakeState.Unknown;
    _this._config = config;
    _this._isPlayer = config.isPlayer;
    _this._parts = null;
    _this._skin = null;
    _this._ableToBoost = null;
    _this._powerUp = null;
    _this._exhaust = null;
    _this._fragments = null;
    _this._consumptionRunnable = null;
    _this._speed = _this._isPlayer ? _constants.PlayerSpeed[CI_API.Globals.PARAMS.player_speed] : _constants.EnemySpeed[CI_API.Globals.PARAMS.enemy_snake_speed];
    _this._energy = 0;
    _this.makeObservable();
    return _this;
  }

  _createClass(SnakeModel, [{
    key: 'destroy',
    value: function destroy() {
    ...
    key: 'updateEnergy',
    value: function updateEnergy(energy) {
    ...
    key: 'startEnergyConsumption',
    value: function startEnergyConsumption() {
      this._consumptionRunnable = (0, _utils.loopRunnable)(300, this._consumeEnergy, this);
    }
  }, {
    key: 'stopEnergyConsumption',
    value: function stopEnergyConsumption() {
      (0, _utils.removeRunnable)(this._consumptionRunnable);
    }
  }, {
    key: 'makeFragments',
    value: function makeFragments() {
      var parts = this._parts.slice(1, this._parts.length);
      this._fragments = { uuid: this._uuid, skin: getSnakeSkinKey(this._skin), parts: parts };
    }
  }, {
    key: '_checkForGrow',
    value: function _checkForGrow() {
      var delta = defaultLength + Math.floor(this._energy / 10) - this._parts.length;
      delta > 0 ? this._addParts(delta) : this._removeParts(Math.abs(delta));
    }
  }, {
    key: '_consumeEnergy',
    value: function _consumeEnergy() {
      this._exhaust = { uuid: this._uuid, skin: getSnakeSkinKey(this._skin) };
      this.updateEnergy(-1);
    }
  }, {
    key: '_addParts',
    value: function _addParts(count) {
      var _parts;

      var parts = [];

      for (var i = 0; i < count; i += 1) {
        var part = new _snakePartModel.SnakePartModel(bodyConfig);
      ...
      (_parts = this._parts).splice.apply(_parts, [this._parts.length - 1, 0].concat(parts));
      this._parts = [].concat(_toConsumableArray(this._parts));
    }
  }, {
    key: '_removeParts',
    value: function _removeParts(count) {
      this._parts.splice(this._parts.length - 2, count);
      this._parts = [].concat(_toConsumableArray(this._parts));
    }
  }, {
    key: '_initParts',
    value: function _initParts() {
      this._initEmptySnake();
      this._addParts(defaultLength - this._parts.length);
    }
  }, {
    key: '_initEmptySnake',
    value: function _initEmptySnake() {
      var parts = [];

      emptySnakeConfig.forEach(function (p, i) {
        var part = new _snakePartModel.SnakePartModel(p);
...
},{"../../../../constants":146,"../../../../utils":266,"../../../observable-model":213,"./snake-part-model":211}],211:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.SnakePartModel = undefined;
...
var SnakePartModel = exports.SnakePartModel = function (_ObservableModel) {
  _inherits(SnakePartModel, _ObservableModel);

  function SnakePartModel(config) {
    _classCallCheck(this, SnakePartModel);

    var _this = _possibleConstructorReturn(this, (SnakePartModel.__proto__ || Object.getPrototypeOf(SnakePartModel)).call(this, 'SnakeModelPart'));
  ...
  return SnakePartModel;
}(_observableModel.ObservableModel);

},{"../../../observable-model":213}],212:[function(require,module,exports){
'use strict';
...
},{"../observable-model":213,"./board/board-model":208}],213:[function(require,module,exports){
'use strict';
...
},{"@armathai/lego":281}],214:[function(require,module,exports){
'use strict';
...
},{"../observable-model":213}],215:[function(require,module,exports){
'use strict';
...
},{"./ad/ad-model":196,"./game/game-model":212,"./observable-model":213,"./player/player-model":214}],216:[function(require,module,exports){
'use strict';
...
},{"./configs/animation-configs":120,"./configs/button-configs":122,"./configs/grid-configs":123,"./configs/image-configs":139,"./configs/ninepatch-configs":141,"./configs/particles-configs":142,"./configs/spine-configs":143,"./configs/text-configs":144,"./utils":266}],217:[function(require,module,exports){
'use strict';
...
},{"../../configs/grid-configs":123,"../../constants":146,"../../events/model-events":151,"@armathai/lego":281,"@armathai/phaser2-grid":286}],218:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.CTA3PPView = undefined;
...
var CTA3PPView = exports.CTA3PPView = function (_CTAView) {
  _inherits(CTA3PPView, _CTAView);

  function CTA3PPView() {
    _classCallCheck(this, CTA3PPView);

    var _this = _possibleConstructorReturn(this, (CTA3PPView.__proto__ || Object.getPrototypeOf(CTA3PPView)).call(this));
  ...
  _createClass(CTA3PPView, [{
    key: 'getGridConfig',
    value: function getGridConfig() {
      return (0, _gridConfigs.getCTA3PPGridConfig)();
    }
  }, {
    key: 'rebuild',
    value: function rebuild(config) {
      ...
      _get(CTA3PPView.prototype.__proto__ || Object.getPrototypeOf(CTA3PPView.prototype), 'rebuild', this).call(this, config);
    }
  }, {
    key: '_build',
    ...
    value: function _show() {
      (0, _utils.postRunnable)(this.showContent, this);
    }
  }]);
...
},{"../../configs/grid-configs":123,"../../utils":266,"./cta-view":225}],219:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.CtaBottomLayer = undefined;
...
var CtaBottomLayer = exports.CtaBottomLayer = function (_CTAView) {
  _inherits(CtaBottomLayer, _CTAView);

  function CtaBottomLayer() {
    _classCallCheck(this, CtaBottomLayer);

    var _this = _possibleConstructorReturn(this, (CtaBottomLayer.__proto__ || Object.getPrototypeOf(CtaBottomLayer)).call(this));
  ...
  _createClass(CtaBottomLayer, [{
    key: 'getGridConfig',
    value: function getGridConfig() {
      return (0, _gridConfigs.getCTABottomLayerGridConfig)();
    }
  }, {
    key: '_getPeelPoints',
    value: function _getPeelPoints() {
      var vPoint = LP([0, -850], [0, -750]);
      var hPoint = LP([-800, 0], [-1200, 0]);
    ...
    key: '_getGlidePoints',
    value: function _getGlidePoints() {
      var vPoint = LP([0, -875], [0, -762.5]);
      var hPoint = LP([-825, 0], [-1225, 0]);
    ...
    value: function _showContent() {
      ...
      this._retryBtn && this.game.add.tween(this._retryBtn).to({ alpha: 1 }, 500, Phaser.Easing.Cubic.InOut, true, 250, 0);
    }
  }, {
    key: '_build',
    value: function _build() {
    ...
    value: function _buildLogo() {
      this._logo = (0, _utils.makeImage)((0, _imageConfigs.getLogoImageConfig)());
      this.setChild('logo', this._logo);
    }
  }, {
    key: '_buildSolidBg',
    value: function _buildSolidBg() {
      this._bg = (0, _utils.makePixel)({ alpha: 1, tint: 0x27546b });
    ...
    key: '_showPagePeel',
    value: function _showPagePeel() {
      this.visible = true;

      var _getPeelPoints2 = this._getPeelPoints(),
          vPoint = _getPeelPoints2.vPoint,
          hPoint = _getPeelPoints2.hPoint;

      var cPoint = [0, 0];
      this.game.add.tween(this._maskShape.currentPath.shape.points).to([].concat(_toConsumableArray(vPoint), cPoint, _toConsumableArray(hPoint)), 750, Phaser.Easing.Sinusoidal.InOut, true, 0).onComplete.add(this._glide, this);
    }
  }, {
    key: '_glide',
    value: function _glide() {
      var cPoint = [0, 0];

      var _getGlidePoints2 = this._getGlidePoints(),
          vPoint = _getGlidePoints2.vPoint,
          hPoint = _getGlidePoints2.hPoint;

      this.game && this.game.add.tween(this._maskShape.currentPath.shape.points).to([].concat(_toConsumableArray(vPoint), cPoint, _toConsumableArray(hPoint)), 1000, Phaser.Easing.Sinusoidal.InOut, true, 0, -1, true);
    }
  }]);

  return CtaBottomLayer;
}(_ctaView.CTAView);

},{"../../configs/grid-configs":123,"../../configs/image-configs":139,"../../utils":266,"./cta-view":225}],220:[function(require,module,exports){
'use strict';
...
var _cta3ppView = require('./cta-3pp-view');

var _ctaEmbeddedView = require('./cta-embedded-view');

var _ctaLoseView = require('./cta-lose-view');

var _ctaPagePeel = require('./cta-page-peel');

var _ctaWinView = require('./cta-win-view');
  ...
  _createClass(CTAContainer, [{
    ...
    value: function _buildStandardCta() {
      ...
      switch (reason) {
        ...
        case _constants.GameOverReasons.TimerToCta:
          this._cta = new _ctaLoseView.CTALoseView();
          break;
        case _constants.GameOverReasons.ScoreToCtaReached:
          this._cta = new _ctaWinView.CTAWinView();
          break;
        default:
          break;
      }
    ...
    key: '_buildPagePeelCta',
    value: function _buildPagePeelCta() {
      this._cta = new _ctaPagePeel.CTAPagePeel();
      this.setChild('cta', this._cta);
    }
  }, {
    key: '_build3PPCta',
    value: function _build3PPCta() {
      var reason = _store.store.ad.cta.reason;
      ...
      switch (reason) {
        ...
        case _constants.GameOverReasons.TimerToCta:
          ...
          break;
        case _constants.GameOverReasons.ScoreToCtaReached:
          this._cta = new _cta3ppView.CTA3PPView();
          break;
        default:
          break;
      }
...
},{"../../configs/grid-configs":123,"../../constants":146,"../../events/model-events":151,"../../models/store":215,"./cta-3pp-view":218,"./cta-embedded-view":221,"./cta-lose-view":222,"./cta-page-peel":223,"./cta-win-view":226,"@armathai/lego":281,"@armathai/phaser2-grid":286}],221:[function(require,module,exports){
'use strict';
...
var CTAEmbeddedView = exports.CTAEmbeddedView = function (_Phaser2Grid) {
  _inherits(CTAEmbeddedView, _Phaser2Grid);

  function CTAEmbeddedView() {
    _classCallCheck(this, CTAEmbeddedView);

    var _this = _possibleConstructorReturn(this, (CTAEmbeddedView.__proto__ || Object.getPrototypeOf(CTAEmbeddedView)).call(this, CI_API.game));
  ...
  _createClass(CTAEmbeddedView, [{
    ...
    value: function _showPopup() {
      var tw = this.game.add.tween(this._label).to({ alpha: 1 }, 500, Phaser.Easing.Cubic.InOut, true);
      tw.universal = true;
    ...
    value: function _buildPopup() {
      this._label = (0, _utils.makeText)((0, _textConfigs.getEmbeddedPopupTextConfig)());
      this._label.alpha = 0;
      this._label.anchor.set(0.5);
      this._label.position.set(25, 0);

      (0, _utils.fitText)(this._label, 300, 200);
    ...
    value: function _showHand() {
      ...
      if (CI_API.Globals.PARAMS.joystick_enabled) {
        var joystickView = (0, _utils.getViewByProperty)('name', 'JoystickView');
        var joystickGlobalPos = this.toGlobal(joystickView.position);
        var joystickLocalPos = this.toLocal(joystickGlobalPos, undefined);
        var joystickX = joystickLocalPos.x,
            joystickY = joystickLocalPos.y;
    ...
    key: '_firstTimeShow',
    value: function _firstTimeShow(initialX, initialY) {
      var _this2 = this;
      ...
      this.game.add.tween(this._hand).from({ x: x + 50, y: y + 50, angle: angle + 30 }, 400, Phaser.Easing.Cubic.Out, true, 1000).onComplete.addOnce(function () {
        _this2._pointHand();
      });
    ...
    value: function _pointHand() {
      var signX = Phaser.Math.sign(this._hand.scale.x);
      var signY = Phaser.Math.sign(this._hand.scale.y);
      var toX = this._hand.scale.x - 0.1 * signX;
      var toY = this._hand.scale.y - 0.1 * signY;
    ...
    key: '_moveHand',
    value: function _moveHand() {
      this._handMoveTw = this.game.add.tween(this._hand).to({ x: '-30', y: '-30' }, 1000, Phaser.Easing.Linear.None, true, 0, -1, true);
    }
  }, {
    key: '_moveTrigger',
    value: function _moveTrigger() {
      var joystickView = (0, _utils.getViewByProperty)('name', 'JoystickView');
      var trigger = joystickView.trigger;


      this._triggerMoveTw = this.game.add.tween(trigger).to({ x: '-30', y: '-30' }, 1000, Phaser.Easing.Linear.None, true, 0, -1, true);
    }
  }]);
...
},{"../../configs/grid-configs":123,"../../configs/image-configs":139,"../../configs/text-configs":144,"../../utils":266,"@armathai/phaser2-grid":286}],222:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.CTALoseView = undefined;
...
var CTALoseView = exports.CTALoseView = function (_CTAView) {
  _inherits(CTALoseView, _CTAView);

  function CTALoseView() {
    _classCallCheck(this, CTALoseView);

    var _this = _possibleConstructorReturn(this, (CTALoseView.__proto__ || Object.getPrototypeOf(CTALoseView)).call(this));
  ...
  _createClass(CTALoseView, [{
    key: 'getGridConfig',
    value: function getGridConfig() {
      return (0, _gridConfigs.getCTAStandardLoseGridConfig)();
    }
  }, {
    key: 'rebuild',
    value: function rebuild(config) {
      ...
      _get(CTALoseView.prototype.__proto__ || Object.getPrototypeOf(CTALoseView.prototype), 'rebuild', this).call(this, config);
    }
  }, {
    key: '_build',
    value: function _build() {
...
},{"../../configs/grid-configs":123,"../../utils":266,"./cta-view":225}],223:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.CTAPagePeel = undefined;
...
var _ctaBottomLayer = require('./cta-bottom-layer');

var _pagePeelComponent = require('./page-peel-component');
...
var CTAPagePeel = exports.CTAPagePeel = function (_Phaser2Grid) {
  _inherits(CTAPagePeel, _Phaser2Grid);

  function CTAPagePeel() {
    _classCallCheck(this, CTAPagePeel);

    var _this = _possibleConstructorReturn(this, (CTAPagePeel.__proto__ || Object.getPrototypeOf(CTAPagePeel)).call(this, CI_API.game));

    _this._build();
    return _this;
  }

  _createClass(CTAPagePeel, [{
    key: 'getGridConfig',
    value: function getGridConfig() {
      return (0, _gridConfigs.getPagePeelCTAGridConfig)();
    }
  }, {
    key: 'rebuild',
    value: function rebuild(config) {
      ...
      _get(CTAPagePeel.prototype.__proto__ || Object.getPrototypeOf(CTAPagePeel.prototype), 'rebuild', this).call(this, config);
      this._ctaBottomLayer && this._rebuildBottomLayer();
      this._pagePeel && this._rebuildPagePeel();
    }
  }, {
    key: '_rebuildBottomLayer',
    value: function _rebuildBottomLayer() {
      this._ctaBottomLayer.destroy();
      this._buildBottomLayer();
    }
  }, {
    key: '_rebuildPagePeel',
    value: function _rebuildPagePeel() {
    ...
    value: function _buildBottomLayer() {
      this._ctaBottomLayer = new _ctaBottomLayer.CtaBottomLayer();
      this.setChild('bottom_layer', this._ctaBottomLayer);
    }
  }, {
    key: '_buildPagePeel',
    value: function _buildPagePeel() {
      this._pagePeel = new _pagePeelComponent.PagePeelComponent();
...
},{"../../configs/grid-configs":123,"./cta-bottom-layer":219,"./page-peel-component":227,"@armathai/phaser2-grid":286}],224:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.CTAPopupView = undefined;
...
var CTAPopupView = exports.CTAPopupView = function (_Container) {
  _inherits(CTAPopupView, _Container);

  function CTAPopupView(type) {
    _classCallCheck(this, CTAPopupView);

    var _this = _possibleConstructorReturn(this, (CTAPopupView.__proto__ || Object.getPrototypeOf(CTAPopupView)).call(this));
  ...
  _createClass(CTAPopupView, [{
    ...
    key: '_buildStandardWinPopup',
    value: function _buildStandardWinPopup() {
      this._bg = (0, _utils.makeImage)((0, _imageConfigs.getCTAPopupBgImageConfig)());
      this._label = (0, _utils.makeText)((0, _textConfigs.getWinPopupTextConfig)());
      this._label.anchor.set(0.5);
      ...
      (0, _utils.fitText)(this._label, width * 0.55, height * 0.7);

      this.addChild(this._bg);
      this.addChild(this._label);
    }
  }, {
    key: '_build3PPWinPopup',
    value: function _build3PPWinPopup() {
      this._bg = (0, _utils.makeNinePatch)((0, _ninepatchConfigs.getNewSkinBubblePatchConfig)());
      this._label = (0, _utils.makeText)((0, _textConfigs.get3PPPopupTextConfig)());
      this._label.anchor.set(0.5);
      ...
      (0, _utils.fitText)(this._label, width * 0.6, height * 0.8);
    ...
    key: '_buildLosePopup',
    value: function _buildLosePopup() {
      this._bg = (0, _utils.makeImage)((0, _imageConfigs.getCTAPopupBgImageConfig)());
      this._label = (0, _utils.makeText)((0, _textConfigs.getLosePopupTextConfig)());
      this._label.anchor.set(0.5);
      this._label.position.set(35, 0);
    ...
    value: function _buildSnake() {
      ...
      this._snakeContainer = new _container.Container();
      this._snakeContainer.getBounds = function () {
        return new Phaser.Rectangle(-100, -50, 200, 100);
      };

      this._snake = (0, _utils.makeSpine)((0, _spineConfigs.getSnakeSpineConfig)());
      this._snake.setSkinByName(skin);
      this._snake.setAnimationByName(0, _spineConfigs.Spines.Snake.Animations.Idle, true);
...
},{"../../configs/image-configs":139,"../../configs/ninepatch-configs":141,"../../configs/spine-configs":143,"../../configs/text-configs":144,"../../utils":266,"../../utils/container":265}],225:[function(require,module,exports){
'use strict';
...
var _ctaPopupView = require('./cta-popup-view');
...
var CTAView = exports.CTAView = function (_Phaser2Grid) {
  ...
  _createClass(CTAView, [{
    ...
    value: function buildPlayButton() {
      this._playBtn = new _button.Button((0, _buttonConfigs.getCtaPlayButtonConfig)());
      this._playBtn.onClick.add(this._onPlayClick, this);
      this._playBtn.alpha = 0;

      var retries = _store.store.ad.retries;
      var reason = _store.store.ad.cta.reason;


      var cell =
      // eslint-disable-next-line no-nested-ternary
      reason !== _constants.GameOverReasons.ScoreToCtaReached ? retries === 0 ? 'middle_button' : 'play_button' : 'play_button';
    ...
    key: 'buildPopup',
    value: function buildPopup(type) {
      this._popup = new _ctaPopupView.CTAPopupView(type);
      this._popup.alpha = 0;
      this._popupContainer = new _container.Container();
    ...
    value: function showPlayBtn() {
      ...
      var twArg = [this._playBtn, 500, 500, false, Phaser.Easing.Cubic.Out];
      var tw = _utils.showFromBottom.apply(undefined, twArg);
    ...
    key: 'showRetryBtn',
    value: function showRetryBtn() {
      var _this3 = this;

      var twArg = [this._retryBtn, 500, 500, false, Phaser.Easing.Cubic.Out];
      var tw = _utils.showFromBottom.apply(undefined, twArg);

      tw.onStart.add(function () {
        _this3._retryBtn.alpha = 1;
      });
    ...
    value: function showBlocker() {
      var tw = this.game.add.tween(this._blocker).to({ alpha: 0.5 }, 500, Phaser.Easing.Cubic.InOut, true);
      tw.universal = true;
    ...
    value: function showPopup() {
      var tw = this.game.add.tween(this._popup).to({ alpha: 1 }, 500, Phaser.Easing.Cubic.InOut, true);
      tw.universal = true;
    ...
    value: function _buildBlocker() {
      this._blocker = (0, _utils.makePixel)({ alpha: 0 });
...
},{"../../configs/button-configs":122,"../../constants":146,"../../events/model-events":151,"../../events/view-events":152,"../../models/store":215,"../../module-bindings":216,"../../utils":266,"../../utils/button/button":263,"../../utils/container":265,"./cta-popup-view":224,"@armathai/lego":281,"@armathai/phaser2-grid":286}],226:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.CTAWinView = undefined;
...
var CTAWinView = exports.CTAWinView = function (_CTAView) {
  _inherits(CTAWinView, _CTAView);

  function CTAWinView() {
    _classCallCheck(this, CTAWinView);

    var _this = _possibleConstructorReturn(this, (CTAWinView.__proto__ || Object.getPrototypeOf(CTAWinView)).call(this));
  ...
  _createClass(CTAWinView, [{
    key: 'getGridConfig',
    value: function getGridConfig() {
      return (0, _gridConfigs.getCTAStandardWinGridConfig)();
    }
  }, {
    key: 'destroy',
    value: function destroy() {
      ...
      _get(CTAWinView.prototype.__proto__ || Object.getPrototypeOf(CTAWinView.prototype), 'destroy', this).call(this);
    }
  }, {
    key: 'rebuild',
    value: function rebuild(config) {
      ...
      _get(CTAWinView.prototype.__proto__ || Object.getPrototypeOf(CTAWinView.prototype), 'rebuild', this).call(this, config);
      this._confettiContainer && this._rebuildConfetti();
    }
  }, {
    key: '_rebuildConfetti',
    value: function _rebuildConfetti() {
    ...
    value: function _buildConfetti() {
      ...
      this._confettiContainer = new _container.Container();
      ...
      this._emitter = (0, _utils.makeEmitter)((0, _particlesConfigs.getCTAWinConfettiEmitterConfig)(this._confettiContainer, this._confettiContainer.getBounds()));
    }
  }, {
    key: '_destroyConfetti',
    value: function _destroyConfetti() {
...
},{"../../configs/grid-configs":123,"../../configs/particles-configs":142,"../../utils":266,"../../utils/container":265,"./cta-view":225}],227:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.PagePeelComponent = undefined;
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* eslint-disable no-restricted-properties */
/* eslint-disable class-methods-use-this */


var PagePeelComponent = exports.PagePeelComponent = function (_Container) {
  _inherits(PagePeelComponent, _Container);

  function PagePeelComponent() {
    _classCallCheck(this, PagePeelComponent);

    var _this = _possibleConstructorReturn(this, (PagePeelComponent.__proto__ || Object.getPrototypeOf(PagePeelComponent)).call(this));

    _this._build();
    return _this;
  }

  _createClass(PagePeelComponent, [{
    key: 'getBounds',
    ...
    key: '_getPeelPoints',
    value: function _getPeelPoints() {
      var vPoint = LP([0, -825], [0, -730]);
      var hPoint = LP([-775, 0], [-1170, 0]);
    ...
    key: '_getGlidePoints',
    value: function _getGlidePoints() {
      var vPoint = LP([0, -25], [0, -12.5]);
      var hPoint = LP([-25, 0], [-25, 0]);
    ...
    key: '_build',
    value: function _build() {
      this._pagePeel = (0, _utils.makeAnimation)((0, _animationConfigs.getPagePeelAnimationConfig)());
      ...
      var _pagePeel = this._pagePeel,
          px = _pagePeel.x,
          py = _pagePeel.y;


      var x = Math.abs(hPoint[0]);
      var y = Math.abs(vPoint[1]);

      var vertical = Math.pow(x, 2) * y / (Math.pow(x, 2) + Math.pow(y, 2));
      var horizontal = Math.pow(y, 2) * x / (Math.pow(x, 2) + Math.pow(y, 2));

      this._pagePeel.animations.play('open', 40, false);

      this.game.add.tween(this._pagePeel).to({ x: px - horizontal, y: py - vertical }, 750, Phaser.Easing.Sinusoidal.InOut, true, 0).onComplete.add(this._glide, this);
    ...
    value: function _glide() {
      ...
      var vertical = Math.pow(x, 2) * y / (Math.pow(x, 2) + Math.pow(y, 2));
      var horizontal = Math.pow(y, 2) * x / (Math.pow(x, 2) + Math.pow(y, 2));
      this.game && this.game.add.tween(this._pagePeel).to({ x: px - horizontal, y: py - vertical }, 1000, Phaser.Easing.Sinusoidal.InOut, true, 0, -1, true);
    }
  }]);

  return PagePeelComponent;
}(_container.Container);

},{"../../configs/animation-configs":120,"../../utils":266,"../../utils/container":265}],228:[function(require,module,exports){
'use strict';
...
var _indicatorView = require('../indicator/indicator-view');
...
var ForegroundView = exports.ForegroundView = function (_Phaser2Grid) {
  ...
  function ForegroundView() {
    ...
    _lego.lego.event.on(_modelEvents.ModelEvents.AdModel.StatusUpdate, _this._onAdStatusUpdate, _this).on(_modelEvents.ModelEvents.SoundModel.IconUpdate, _this._onSoundIconUpdate, _this).on(_modelEvents.ModelEvents.AdModel.HintUpdate, _this._onHintUpdate, _this).on(_modelEvents.ModelEvents.AdModel.TutorialUpdate, _this._onTutorialUpdate, _this).on(_modelEvents.ModelEvents.AdModel.PlayableIndicatorUpdate, _this._onIndicatorUpdate, _this).on(_modelEvents.ModelEvents.TutorialModel.CompleteUpdate, _this._onTutorialCompleteUpdate, _this).on(_modelEvents.ModelEvents.TutorialModel.SkipUpdate, _this._onTutorialSkipUpdate, _this);
    return _this;
  }
  ...
  _createClass(ForegroundView, [{
      ...
      switch (status) {
        ...
        case _constants.AdStatus.Cta:
          ...
          if (ctaType === 'page_peel') {
            ...
            this._showLogo();
          } else if (ctaType === 'embedded' && _store.store.ad.cta.reason === _constants.GameOverReasons.Failed) {
            this._showLogo();
          }
          break;
        default:
    ...
    value: function _buildLogo() {
      ...
      var cell = reason !== _constants.GameOverReasons.ScoreToCtaReached ? 'lose_cta_logo' : 'logo';
      this._logoView && this._logoView.destroy();
      this.setChild(cell, this._logoView = new _logoView.LogoView());
    ...
    key: '_onTutorialCompleteUpdate',
    value: function _onTutorialCompleteUpdate(complete) {
      complete && this._hideTutorial().onComplete.add(this._destroyTutorial, this);
    }
  }, {
    key: '_onTutorialSkipUpdate',
    value: function _onTutorialSkipUpdate(skip) {
    ...
    value: function _hideTutorial() {
      this._tutorialHideTw = this.game.add.tween(this._tutorialView).to({ alpha: 0 }, 250, Phaser.Easing.Sinusoidal.InOut, true);
      this._tutorialHideTw.universal = true;

      this._tutorialHideTw.onComplete.add(function () {
        _lego.lego.event.emit(_viewEvents.ViewEvents.TutorialView.HideComplete);
      });
    ...
    key: '_onIndicatorUpdate',
    value: function _onIndicatorUpdate(value) {
      value ? this._buildIndicator() : this._destroyIndicator();
    }
  }, {
    key: '_buildIndicator',
    value: function _buildIndicator() {
      var _this2 = this;

      this._indicatorView = new _indicatorView.IndicatorView();
      this.setChild('indicator', this._indicatorView);
      (0, _utils.postRunnable)(function () {
        _this2._indicatorView.show();
      });
    }
  }, {
    key: '_destroyIndicator',
    value: function _destroyIndicator() {
      this._indicatorView.hide(_store.store.ad.cta.preVisible);
    }
  }, {
    key: 'name',
    get: function get() {
...
},{"../../configs/grid-configs":123,"../../constants":146,"../../events/model-events":151,"../../events/view-events":152,"../../models/store":215,"../../utils":266,"../indicator/indicator-view":241,"./hint-view":229,"./logo-view":230,"./sound-view":231,"./tutorial-view":233,"@armathai/lego":281,"@armathai/phaser2-grid":286}],229:[function(require,module,exports){
'use strict';
...
var HintView = exports.HintView = function (_Phaser$Sprite) {
  ...
  _createClass(HintView, [{
    ...
    key: '_pointHand',
    value: function _pointHand() {
      var signX = Phaser.Math.sign(this.scale.x);
      var signY = Phaser.Math.sign(this.scale.y);
      var toX = this.scale.x - 0.1 * signX;
      var toY = this.scale.y - 0.1 * signY;
    ...
    key: '_moveHand',
    value: function _moveHand() {
      this._handMoveTw = this.game.add.tween(this).to({ x: '-30', y: '-30' }, 1000, Phaser.Easing.Linear.None, true, 0, -1, true);
    }
  }, {
    key: '_moveTrigger',
    value: function _moveTrigger() {
...
},{"../../events/model-events":151,"../../utils":266,"@armathai/lego":281}],230:[function(require,module,exports){
'use strict';
...
var LogoView = exports.LogoView = function (_Phaser$Sprite) {
  ...
  function LogoView() {
    ...
    _this.input.priorityID = _constants.InputPriority.Foreground;
    _this.name = 'logo';
    return _this;
  }
...
},{"../../constants":146,"../../utils":266}],231:[function(require,module,exports){
'use strict';
...
},{"../../constants":146,"../../events/model-events":151,"../../events/view-events":152,"../../utils/container":265,"@armathai/lego":281}],232:[function(require,module,exports){
'use strict';
...
var TutorialSequenceView = exports.TutorialSequenceView = function (_Phaser2Grid) {
  ...
  _createClass(TutorialSequenceView, [{
    ...
    value: function rebuild(config) {
      ...
      _get(TutorialSequenceView.prototype.__proto__ || Object.getPrototypeOf(TutorialSequenceView.prototype), 'rebuild', this).call(this, config);
    }
  }, {
    key: '_rebuildHand',
    value: function _rebuildHand() {
    ...
    value: function _buildBg() {
      this._bg = (0, _utils.makeNinePatch)((0, _ninepatchConfigs.getTutorialBgPatchConfig)());
...
},{"../../configs/grid-configs":123,"../../configs/image-configs":139,"../../configs/ninepatch-configs":141,"../../configs/text-configs":144,"../../utils":266,"@armathai/phaser2-grid":286}],233:[function(require,module,exports){
'use strict';
...
var TutorialView = exports.TutorialView = function (_Phaser2Grid) {
  ...
  function TutorialView() {
    ...
    _this._current = null;
    _this._sequenceShowTw = null;
    _this._sequenceHideTw = null;
    ...
    _lego.lego.event.on(_modelEvents.ModelEvents.JoystickModel.StateUpdate, _this._onJoystickStateUpdate, _this);
    return _this;
  }
  ...
  _createClass(TutorialView, [{
    ...
    value: function destroy() {
      ...
      (0, _utils.removeRunnable)(this._sequenceShowRunnable);
    ...
    value: function _onTutorialCurrentCompleteUpdate(complete) {
      ...
      this._sequenceHideTw.onComplete.addOnce(function () {
    ...
    key: '_onJoystickStateUpdate',
    value: function _onJoystickStateUpdate(state) {
      switch (state) {
        case _constants.JoystickState.Pressed:
    ...
    value: function _buildHitArea() {
      this._hitArea = (0, _utils.makePixel)({ alpha: 0 });
      this._hitArea.inputEnabled = true;
      this._hitArea.input.priorityID = _constants.InputPriority.Game;
    ...
    value: function _buildSequence(sequence, force) {
      ...
      if (!force) {
        this._sequenceShowRunnable = (0, _utils.postRunnable)(function () {
          _this3._sequenceShowTw = _this3._current.show();
          _this3._sequenceShowTw.onComplete.addOnce(function () {
...
},{"../../configs/grid-configs":123,"../../constants":146,"../../events/model-events":151,"../../events/view-events":152,"../../models/store":215,"../../utils":266,"./tutorial-sequence-view":232,"@armathai/lego":281,"@armathai/phaser2-grid":286}],234:[function(require,module,exports){
'use strict';
...
var _foodView = require('./food-view');

var _snakeView = require('./snake-view');
...
function getPlayerLuck() {
  var random = (0, _randomReal.randomReal)(0, 1);
  var luck = false;

  if (_store.store.ad.status === _constants.AdStatus.Cta) {
    luck = true;
    return luck;
  }
...
var BoardView = exports.BoardView = function (_Container) {
  ...
  function BoardView() {
    ...
    _lego.lego.event.on(_modelEvents.ModelEvents.BoardModel.SnakesUpdate, _this._onSnakesUpdate, _this);
    _lego.lego.event.on(_modelEvents.ModelEvents.BoardModel.FoodsUpdate, _this._onFoodsUpdate, _this);
    _lego.lego.event.on(_modelEvents.ModelEvents.SnakeModel.ExhaustUpdate, _this._onSnakeExhaustUpdate, _this);
    _lego.lego.event.on(_modelEvents.ModelEvents.SnakeModel.FragmentsUpdate, _this._onSnakeFragmentsUpdate, _this);
  ...
  _createClass(BoardView, [{
    ...
    value: function update() {
      _get(BoardView.prototype.__proto__ || Object.getPrototypeOf(BoardView.prototype), 'update', this).call(this);
      var status = _store.store.ad.status;
      var ctaType = CI_API.Globals.PARAMS.cta_type;


      if (this._playerSnake && (status === _constants.AdStatus.Game || status === _constants.AdStatus.Cta && ctaType === 'embedded')) {
        this._focusCameraOnPlayerSnake();
      }

      if (_store.store.game.boardModel.state === _constants.BoardState.Paused) {
        return;
      }
      ...
      status === _constants.AdStatus.Game && this._checkCollisionsWithFood();
    }
  }, {
    key: '_onSnakeExhaustUpdate',
    value: function _onSnakeExhaustUpdate(info) {
      var uuid = info.uuid,
          skin = info.skin;

      var snake = this.getSnakeByUuid(uuid);
      var tail = snake.tail;
      var position = tail.position,
          parent = tail.parent;


      var localPos = this.toLocal(position, parent);
      _lego.lego.event.emit(_viewEvents.ViewEvents.BoardView.SnakeExhaust, { skin: skin, position: localPos });
    }
  }, {
    key: '_onSnakeFragmentsUpdate',
    value: function _onSnakeFragmentsUpdate(info) {
      var _this2 = this;
      ...
      var snake = this.getSnakeByUuid(uuid);
      var fragmentsConfig = parts.map(function (p) {
        var part = snake.getPartByUuid(p.uuid);
        ...
        var offset = (0, _randomReal.randomReal)(-10, 10);
        var localPos = _this2.toLocal(new Phaser.Point(x + offset, y + offset), parent);
        return { angle: rotation, position: localPos, skin: skin, bodyPart: type, type: _constants.FoodType.Super };
      });
      _lego.lego.event.emit(_viewEvents.ViewEvents.BoardView.FragmentsDrop, fragmentsConfig);
    }
  }, {
    key: '_checkCollisionsWithFood',
    value: function _checkCollisionsWithFood() {
      var _this3 = this;
      ...
      this._snakes.forEach(function (snake) {
        ...
        _this3._foods.forEach(function (food) {
          if (Phaser.Circle.intersects(head.collisionBody, food.collisionBody)) {
            _lego.lego.event.emit(_viewEvents.ViewEvents.BoardView.SnakeEatFood, { snake: snake.uuid, food: food.uuid });
          }
        });
      });
    }
  }, {
    key: '_checkCollisionsBetweenSnakes',
    value: function _checkCollisionsBetweenSnakes() {
      var _this4 = this;

      this._snakes.forEach(function (currentSnake) {
        var head = currentSnake.head;


        _this4._snakes.forEach(function (snake) {
          if (currentSnake.uuid !== snake.uuid) {
            if (CI_API.Globals.PARAMS.damage_type === 'head_only') {
              if (Phaser.Circle.intersects(head.collisionBody, snake.head.collisionBody)) {
                _lego.lego.event.emit(_viewEvents.ViewEvents.BoardView.SnakeBites, { biter: currentSnake.uuid, bitten: snake.uuid });
              }
            } else {
              snake.parts.forEach(function (p) {
    ...
    key: '_checkBordersCollision',
    value: function _checkBordersCollision() {
      var _this5 = this;
      ...
      this.snakes.forEach(function (snake) {
        ...
        var width = _constants.boardDimensions.width,
            height = _constants.boardDimensions.height;
        var collisionBody = snake.head.collisionBody;
        var x = collisionBody.x,
            y = collisionBody.y,
            diameter = collisionBody.diameter;

        var _toLocal = _this5.toLocal(new Phaser.Point(x, y), null),
            localX = _toLocal.x,
            localY = _toLocal.y;

        if (localX + diameter / 2 > width || localX - diameter / 2 < 0 || localY + diameter / 2 > height || localY - diameter / 2 < 0) {
          _lego.lego.event.emit(_viewEvents.ViewEvents.BoardView.SnakeCollideWithBorder, uuid);
        }
      });
    }
  }, {
    key: '_controlSnakesMovement',
    value: function _controlSnakesMovement() {
      var _this6 = this;

      var status = _store.store.ad.status;

      this._snakes.forEach(function (snake) {
        if (_this6._playerSnake === snake && status === _constants.AdStatus.Game) {
          return;
        }

        _this6._avoidBorders(snake);
        _this6._avoidEnemies(snake);
        status === _constants.AdStatus.Game && _this6._targetFood(snake);
      });
    }
  }, {
    key: '_targetFood',
    value: function _targetFood(snake) {
      var detectorBody = snake.head.detectorBody;


      for (var i = 0; i < this._foods.length; i += 1) {
        var food = this._foods[i];
        var collisionBody = food.collisionBody;


        if (Phaser.Circle.intersects(detectorBody, food.collisionBody)) {
          var rad = Phaser.Math.angleBetweenPoints(collisionBody, detectorBody);
          var newDirection = rad + Math.PI / 2;
    ...
    key: '_avoidEnemies',
    value: function _avoidEnemies(snake) {
      var detectorBody = snake.head.detectorBody;

      var offset = (0, _randomInt.randomInt)(Math.PI / 4, Math.PI / 4);

      this._snakes.forEach(function (s) {
        if (s !== snake) {
          for (var i = 0; i < s.parts.length; i += 1) {
            var p = s.parts[i];
            var collisionBody = p.collisionBody;


            if (Phaser.Circle.intersects(detectorBody, collisionBody)) {
              var rad = Phaser.Math.angleBetweenPoints(collisionBody, detectorBody);
              var newDirection = rad - Math.PI + offset;
    ...
    key: '_avoidBorders',
    value: function _avoidBorders(snake) {
      var newDirection = null;
      var offset = (0, _randomInt.randomInt)(-45, 45);
      var direction = snake.getDirection();
      var width = _constants.boardDimensions.width,
          height = _constants.boardDimensions.height;
      var detectorBody = snake.head.detectorBody;
      var x = detectorBody.x,
          y = detectorBody.y,
          diameter = detectorBody.diameter;

      var _toLocal2 = this.toLocal(new Phaser.Point(x, y), null),
          localX = _toLocal2.x,
          localY = _toLocal2.y;
    ...
    key: '_focusCameraOnPlayerSnake',
    value: function _focusCameraOnPlayerSnake() {
      var _getGameBounds = (0, _utils.getGameBounds)(),
          width = _getGameBounds.width,
          height = _getGameBounds.height;

      var snakePos = this._playerSnake.getPosition();
      this.position.set(width / 2 - snakePos.x, height / 2 - snakePos.y);
    }
  }, {
    key: '_onFoodsUpdate',
    value: function _onFoodsUpdate(foods) {
      var views = this._foods.map(function (f) {
        return f.uuid;
      });
      var models = foods.map(function (f) {
        return f.uuid;
      });
      var add = (0, _difference.difference)(models, views);
      var remove = (0, _difference.difference)(views, models);
      add.length > 0 && this._addFoods(foods, add);
      remove.length > 0 && this._removeFoods(remove);
    }
  }, {
    key: '_addFoods',
    value: function _addFoods(foods, diff) {
      var _foods,
          _this7 = this;

      (_foods = this._foods).push.apply(_foods, _toConsumableArray(foods.filter(function (f) {
        return diff.includes(f.uuid);
      }).map(function (f) {
        return _this7._makeFood(f);
      })));
    }
  }, {
    key: '_removeFoods',
    value: function _removeFoods(diff) {
      var _this8 = this;

      diff.forEach(function (d) {
        var index = _this8._foods.findIndex(function (f) {
          return f.uuid === d;
        });
        var removedFoods = _this8._foods.splice(index, 1);

        var type = removedFoods[0].config.type;

        _lego.lego.event.emit(_viewEvents.ViewEvents.BoardView.FoodEaten, type);
    ...
    key: '_makeFood',
    value: function _makeFood(foodModel) {
      var uuid = foodModel.uuid,
          config = foodModel.config;

      var food = new _foodView.FoodView(uuid, config);
    ...
    key: '_onSnakesUpdate',
    value: function _onSnakesUpdate(snakes) {
      var views = this._snakes.map(function (s) {
        return s.uuid;
      });
      var models = snakes.map(function (s) {
        return s.uuid;
      });
      var add = (0, _difference.difference)(models, views);
      var remove = (0, _difference.difference)(views, models);
    ...
    key: '_addSnakes',
    value: function _addSnakes(snakes, diff) {
      var _snakes,
          _this9 = this;

      (_snakes = this._snakes).push.apply(_snakes, _toConsumableArray(snakes.filter(function (s) {
        return diff.includes(s.uuid);
      }).map(function (s) {
        var snakeView = _this9._makeSnake(s);
        return _this9.addChild(snakeView);
      })));
    }
  }, {
    key: '_removeSnakes',
    value: function _removeSnakes(diff) {
      var _this10 = this;

      diff.forEach(function (d) {
        var index = _this10._snakes.findIndex(function (s) {
          return s.uuid === d;
        });
        var removedSnake = _this10._snakes.splice(index, 1);

        removedSnake[0].destroy();

        var _removedSnake$0$getPo = removedSnake[0].getPosition(),
            x = _removedSnake$0$getPo.x,
            y = _removedSnake$0$getPo.y;

        _this10._makeExplosion(x, y + 100);

        if (_this10._playerSnake && _this10._playerSnake.uuid === d) {
          _this10._playerSnake = null;
        }
      });
    }
  }, {
    key: '_makeSnake',
    value: function _makeSnake(snakeModel) {
      var uuid = snakeModel.uuid,
          skin = snakeModel.skin,
          parts = snakeModel.parts,
          config = snakeModel.config,
          isPlayer = snakeModel.isPlayer;
      var initialDirection = config.initialDirection,
      ...
      var snake = new _snakeView.SnakeView(uuid, skin, parts, name);
    ...
    key: '_makeExplosion',
    value: function _makeExplosion(x, y) {
      var explosion = (0, _utils.makeAnimation)((0, _animationConfigs.getSnakeDeathAnimationConfig)());
    ...
    value: function _buildBg() {
      ...
      var _searchAtlasByFrame = (0, _utils.searchAtlasByFrame)('ui/hand.png'),
          key = _searchAtlasByFrame.key;

      var bg = new Phaser.TileSprite(this.game, 0, 0, width, height, key, frame);

      this.addChild(bg);
    }
  }, {
    key: '_buildBorders',
    value: function _buildBorders() {
      var width = _constants.boardDimensions.width,
          height = _constants.boardDimensions.height;

      var top = (0, _utils.makeNinePatch)((0, _ninepatchConfigs.getBoardBorderHorizontalLineNinePatchConfig)());
      this.addChild(top);
      top.position.set(-_constants.boardBorderOffset, -_constants.boardBorderOffset);

      var bottom = (0, _utils.makeNinePatch)((0, _ninepatchConfigs.getBoardBorderHorizontalLineNinePatchConfig)());
      this.addChild(bottom);
      bottom.scale.set(1, -1);
      bottom.position.set(-_constants.boardBorderOffset, height + _constants.boardBorderOffset);

      var right = (0, _utils.makeNinePatch)((0, _ninepatchConfigs.getBoardBorderHorizontalLineNinePatchConfig)());
      this.addChild(right);
      right.angle = 90;
      right.position.set(width + _constants.boardBorderOffset, -_constants.boardBorderOffset);

      var left = (0, _utils.makeNinePatch)((0, _ninepatchConfigs.getBoardBorderHorizontalLineNinePatchConfig)());
      this.addChild(left);
      left.angle = -90;
      left.position.set(-_constants.boardBorderOffset, height + _constants.boardBorderOffset);
    }
  }, {
    key: 'name',
    get: function get() {
...
},{"../../../configs/animation-configs":120,"../../../configs/image-configs":139,"../../../configs/ninepatch-configs":141,"../../../constants":146,"../../../events/model-events":151,"../../../events/view-events":152,"../../../models/store":215,"../../../utils":266,"../../../utils/array/difference":258,"../../../utils/container":265,"../../../utils/number/random-int":267,"../../../utils/number/random-real":268,"./food-view":235,"./snake-view":237,"@armathai/lego":281}],235:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.FoodView = undefined;
...
var FoodView = exports.FoodView = function (_Container) {
  _inherits(FoodView, _Container);

  function FoodView(uuid, config) {
    _classCallCheck(this, FoodView);

    var _this = _possibleConstructorReturn(this, (FoodView.__proto__ || Object.getPrototypeOf(FoodView)).call(this));

    _this._collisionBody = null;
    _this._uuid = uuid;
    _this._config = config;
    _this._build();
    return _this;
  ...
  _createClass(FoodView, [{
    key: 'update',
    value: function update() {
      _get(FoodView.prototype.__proto__ || Object.getPrototypeOf(FoodView.prototype), 'update', this).call(this);

      this.updateCollisionBodyPosition();
    }
  }, {
    key: 'updateCollisionBodyPosition',
    value: function updateCollisionBodyPosition() {
      var _toGlobal = this.toGlobal(this._content.position),
          x = _toGlobal.x,
          y = _toGlobal.y;
    ...
    key: '_buildCollisionBody',
    value: function _buildCollisionBody() {
    ...
    value: function _buildContent() {
      ...
      this._content = type === _constants.FoodType.Regular ? this._makeRegularFood() : this._makeSuperFood();
    ...
    key: '_makeSuperFood',
    value: function _makeSuperFood() {
      var _config2 = this._config,
          skin = _config2.skin,
          bodyPart = _config2.bodyPart;


      var img = (0, _utils.makeImage)((0, _imageConfigs.getSnakePartImageConfig)(_constants.SnakeSkin[skin], bodyPart));
      img.scale.set(0.8);

      return img;
    }
  }, {
    key: '_makeRegularFood',
    value: function _makeRegularFood() {
      var skin = this._config.skin;


      var gr = this.game.add.graphics();
      gr.beginFill(_constants.SkinColors[skin], 1);
...
},{"../../../configs/image-configs":139,"../../../constants":146,"../../../utils":266,"../../../utils/container":265}],236:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.SnakePartComponent = undefined;
...
var SnakePartComponent = exports.SnakePartComponent = function (_Container) {
  _inherits(SnakePartComponent, _Container);

  function SnakePartComponent(config) {
    _classCallCheck(this, SnakePartComponent);

    var _this = _possibleConstructorReturn(this, (SnakePartComponent.__proto__ || Object.getPrototypeOf(SnakePartComponent)).call(this));
    ...
    _this._collisionBody = null;
    _this._spine = null;
    _this._backNode = null;
    _this._frontNode = null;

    _this._build();
    return _this;
  }

  _createClass(SnakePartComponent, [{
    key: '_build',
    value: function _build() {
      this._config.type === _constants.SnakePartType.Head && this._buildDetectorBody();
      this._buildCollisionBody();
      this._buildSkin();
      this._buildNodes();
      this._buildSpine();
    ...
    key: '_buildCollisionBody',
    value: function _buildCollisionBody() {
      var bodyRadius = dimensions.bodyRadius,
          height = dimensions.height;
      var type = this._config.type;

      // ..............

      var gr = this.game.add.graphics(0, type === _constants.SnakePartType.Head ? height / 2 : -height / 2);
      gr.beginFill(0xff0000, 0);
    ...
    key: '_buildDetectorBody',
    value: function _buildDetectorBody() {
      var bodyRadius = dimensions.bodyRadius,
          height = dimensions.height;

      // ..............

      var gr = this.game.add.graphics(0, height / 2);
      gr.beginFill(0xff0000, 0);
    ...
    value: function _buildSpine() {
      ...
      gr.drawRect(-width / 2, 0, width, type === _constants.SnakePartType.Head ? height : -height);
      this.addChild(this._spine = gr);
    }
  }, {
    key: '_buildNodes',
    value: function _buildNodes() {
      var height = dimensions.height;
      var type = this._config.type;


      if (type === _constants.SnakePartType.Head) {
        var gr = this.game.add.graphics(0, 0);
        gr.beginFill(0xff0000, 0);
        gr.drawCircle(0, 0, 20);
        this.addChild(this._backNode = gr);

        var gr1 = this.game.add.graphics(0, height);
        gr1.beginFill(0x0000ff, 0);
        gr1.drawCircle(0, 0, 20);
        this.addChild(this._frontNode = gr1);
      } else {
        var _gr = this.game.add.graphics(0, 0);
        _gr.beginFill(0x0000ff, 0);
        _gr.drawCircle(0, 0, 20);
        this.addChild(this._frontNode = _gr);

        var _gr2 = this.game.add.graphics(0, -height);
        _gr2.beginFill(0xff0000, 0);
        _gr2.drawCircle(0, 0, 20);
        this.addChild(this._backNode = _gr2);
      }
    }
  }, {
    key: '_buildSkin',
    value: function _buildSkin() {
      var height = dimensions.height;
      var _config = this._config,
          skin = _config.skin,
          type = _config.type;

      var img = (0, _utils.makeImage)((0, _imageConfigs.getSnakePartImageConfig)(skin, type));
      img.position.set(0, type === _constants.SnakePartType.Head ? height / 2 : -height / 2);
  ...
  return SnakePartComponent;
}(_container.Container);

},{"../../../configs/image-configs":139,"../../../constants":146,"../../../utils":266,"../../../utils/container":265}],237:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.SnakeView = undefined;
...
var _snakePartComponent = require('./snake-part-component');
...
var SnakeView = exports.SnakeView = function (_Container) {
  _inherits(SnakeView, _Container);

  function SnakeView(uuid, skin, parts, name) {
    _classCallCheck(this, SnakeView);

    var _this = _possibleConstructorReturn(this, (SnakeView.__proto__ || Object.getPrototypeOf(SnakeView)).call(this));

    _this._parts = null;
    _this._path = [];
    _this._skin = skin;
    _this._uuid = uuid;
    _this._autopilotOn = true;
    _this._autopilotCooldownRunnable = null;

    _lego.lego.event.on(_modelEvents.ModelEvents.SnakeModel.PartsUpdate, _this._onPartsUpdate, _this);

    _this._build(skin, parts, name);
    return _this;
  }
  ...
  _createClass(SnakeView, [{
    ...
    key: 'setDirection',
    value: function setDirection(rad) {
    ...
    value: function getPartByUuid(uuid) {
      return this._parts.find(function (p) {
        return p.uuid === uuid;
      });
    }
  }, {
    key: 'turnOffAutopilot',
    value: function turnOffAutopilot() {
      var _this2 = this;
      ...
      this._autopilotCooldownRunnable = (0, _utils.delayRunnable)(400, function () {
        (0, _utils.removeRunnable)(_this2._autopilotCooldownRunnable);
        _this2._autopilotCooldownRunnable = null;
        _this2._autopilotOn = true;
      });
    }
  }, {
    key: 'destroy',
    value: function destroy() {
      (0, _utils.removeRunnable)(this._autopilotCooldownRunnable);
      _get(SnakeView.prototype.__proto__ || Object.getPrototypeOf(SnakeView.prototype), 'destroy', this).call(this);
    }
  }, {
    key: 'update',
    value: function update() {
      ...
      _get(SnakeView.prototype.__proto__ || Object.getPrototypeOf(SnakeView.prototype), 'update', this).call(this);

      var boardModel = _store.store.game.boardModel;


      this._parts.forEach(function (part, index) {
        var nextPart = _this3._parts[index + 1];
        if (nextPart) {
          _this3._updatePartAngle(part, nextPart);
          _this3._updatePartPosition(part, nextPart);
        }
        _this3._updatePartCollisionBodyPosition(part);
      });

      this._name.position.set(this.head.x, this.head.y - 30);

      if (boardModel.state === _constants.BoardState.Paused) {
        return;
      }

      var _store$game$boardMode = _store.store.game.boardModel.getSnakeByUuid(this._uuid),
          speed = _store$game$boardMode.speed;
    ...
    key: '_onPartsUpdate',
    value: function _onPartsUpdate(parts, prevValue, uuid) {
      if (this._uuid !== uuid) {
        return;
      }

      var views = this._parts.map(function (p) {
        return p.uuid;
      });
    ...
    key: '_addParts',
    value: function _addParts(parts, diff) {
      var _this4 = this,
          _parts;

      var newParts = parts.filter(function (p) {
        return diff.includes(p.uuid);
      }).map(function (p) {
        var partView = _this4._makePart(p);
        _this4.addChild(partView);

        return partView;
      });
      (_parts = this._parts).splice.apply(_parts, [this._parts.length - 1, 0].concat(_toConsumableArray(newParts)));
    }
  }, {
    key: '_removeParts',
    value: function _removeParts(diff) {
      var _this5 = this;

      diff.forEach(function (d) {
        var index = _this5._parts.findIndex(function (p) {
          return p.uuid === d;
        });
        var removedParts = _this5._parts.splice(index, 1);

        removedParts[0].destroy();
      });
    }
  }, {
    key: '_updatePartsLayersOrder',
    value: function _updatePartsLayersOrder() {
      var _this6 = this;

      this._parts.forEach(function (p) {
        return _this6.addChildAt(p, 0);
      });
    }
  }, {
    key: '_updatePartAngle',
    value: function _updatePartAngle(part, nextPart) {
      var nextBackNode = nextPart.backNode;
      var currentBackNode = part.backNode;


      var nextBackNodeLocal = this.toLocal(nextBackNode, nextPart);
      var currentBackNodeLocal = this.toLocal(currentBackNode, part);

      // @ts-ignore
      var angle = Phaser.Math.angleBetweenPoints(nextBackNodeLocal, currentBackNodeLocal);
      nextPart.rotation = angle - Math.PI / 2;
    }
  }, {
    key: '_updatePartPosition',
    value: function _updatePartPosition(part, nextPart) {
      var currentBackNode = part.backNode;
    ...
    key: '_updatePartCollisionBodyPosition',
    value: function _updatePartCollisionBodyPosition(part) {
      var centralPosition = part.centralPosition;

      var _part$toGlobal = part.toGlobal(centralPosition),
          x = _part$toGlobal.x,
          y = _part$toGlobal.y;
    ...
    key: '_build',
    value: function _build(skin, parts, name) {
      this._buildParts(parts);
      this._buildName(name);
    }
  }, {
    key: '_buildName',
    value: function _buildName(name) {
      this._name = (0, _utils.makeText)((0, _textConfigs.getSnakeNameTextConfig)(name));
      this._name.anchor.set(0.5);
      (0, _utils.fitText)(this._name, 150, 150);
    ...
    value: function _buildParts(parts) {
      ...
      this._parts = parts.map(function (partModel) {
        return _this7._makePart(partModel);
      });
    }
  }, {
    key: '_makePart',
    value: function _makePart(partModel) {
      var type = partModel.type,
          uuid = partModel.uuid;

      var part = new _snakePartComponent.SnakePartComponent({ skin: this._skin, type: type, uuid: uuid });
      // part.y = -index * 50;
    ...
    key: 'tail',
    get: function get() {
      return (0, _last.last)(this._parts);
    }
  }, {
    key: 'parts',
    get: function get() {
...
},{"../../../configs/text-configs":144,"../../../constants":146,"../../../events/model-events":151,"../../../models/store":215,"../../../utils":266,"../../../utils/array/difference":258,"../../../utils/array/last":259,"../../../utils/container":265,"./snake-part-component":236,"@armathai/lego":281}],238:[function(require,module,exports){
'use strict';
...
var GameView = exports.GameView = function (_Phaser2Grid) {
  ...
  function GameView() {
    ...
    _this._inputArea = null;

    _this.build(_this.getGridConfig());

    _lego.lego.event.on(_modelEvents.ModelEvents.GameModel.BoardModelUpdate, _this._onBoardUpdate, _this).on(_modelEvents.ModelEvents.AdModel.StatusUpdate, _this._onAdStatusUpdate, _this).on(_modelEvents.ModelEvents.BoardModel.StateUpdate, _this._onBoardStateUpdate, _this);
    return _this;
  }
  ...
  _createClass(GameView, [{
    ...
    key: '_onFirstClick',
    value: function _onFirstClick() {
      _lego.lego.event.emit(_viewEvents.ViewEvents.GameView.FirstClickOnController);
    }
  }, {
    key: '_onUp',
    value: function _onUp() {
      ...
      this._inputArea.events.onInputDown.addOnce(this._onDown, this);
      _lego.lego.event.emit(_viewEvents.ViewEvents.GameView.InputUp);

      this._destroyJoystick();
    }
  }, {
    key: '_onDown',
    value: function _onDown(target, pointer) {
      this._pointer = pointer;
      this.game.input.addMoveCallback(this._onMove, this);
      _lego.lego.event.emit(_viewEvents.ViewEvents.GameView.InputDown);
    ...
    value: function _onMove(pointer) {
      if (pointer === this._pointer && _store.store.ad.status === _constants.AdStatus.Game) {
        var width = this._joystickBg.width;
        var pointerX = pointer.x,
            pointerY = pointer.y;
        var _joystickBg = this._joystickBg,
            downX = _joystickBg.x,
            downY = _joystickBg.y;

        var distance = Math.min(width / 2, Phaser.Math.distance(downX, downY, pointerX, pointerY));

        var rad = Phaser.Math.angleBetweenPoints(new Phaser.Point(downX, downY), new Phaser.Point(pointerX, pointerY));
    ...
    value: function _onAdStatusUpdate(status) {
      ...
      switch (status) {
        ...
        case _constants.AdStatus.PreCta:
          ...
          break;
        case _constants.AdStatus.Cta:
          if (ctaType === 'embedded' && _store.store.ad.cta.reason !== _constants.GameOverReasons.Failed) {
    ...
    key: '_buildCTABlocker',
    value: function _buildCTABlocker() {
      this._ctaBlocker = (0, _utils.makePixel)({ alpha: 0 });
      this._ctaBlocker.inputEnabled = true;
      this._ctaBlocker.input.priorityID = _constants.InputPriority.Cta;
    ...
    key: '_showCTABlocker',
    value: function _showCTABlocker() {
      var tw = this.game.add.tween(this._ctaBlocker).to({ alpha: 0.5 }, 500, Phaser.Easing.Cubic.InOut, true);
      tw.universal = true;

      return tw;
    }
  }, {
    key: '_onCTABlockerClick',
    value: function _onCTABlockerClick() {
      _lego.lego.event.emit(_viewEvents.ViewEvents.CtaView.ScreenClick);
    }
    ...
    value: function _buildBoard() {
      this.addChild(this._boardView = new _boardView.BoardView());
    }
  }, {
    key: '_destroyBoard',
    ...
    key: '_buildInputArea',
    value: function _buildInputArea() {
      var inputArea = (0, _utils.makePixel)({ width: 1, height: 1, alpha: 0 });
    ...
    key: '_buildJoystickTrigger',
    value: function _buildJoystickTrigger(x, y) {
      var gr = this.game.add.graphics();
      gr.beginFill(0xffffff, 0);
...
},{"../../configs/grid-configs":123,"../../constants":146,"../../events/model-events":151,"../../events/view-events":152,"../../models/store":215,"../../utils":266,"./board/board-view":234,"@armathai/lego":281,"@armathai/phaser2-grid":286}],239:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.AbstractIndicator = undefined;
...
var AbstractIndicator = exports.AbstractIndicator = function (_Container) {
  _inherits(AbstractIndicator, _Container);

  function AbstractIndicator() {
    _classCallCheck(this, AbstractIndicator);

    return _possibleConstructorReturn(this, (AbstractIndicator.__proto__ || Object.getPrototypeOf(AbstractIndicator)).apply(this, arguments));
  }

  _createClass(AbstractIndicator, [{
    key: 'destroy',
    value: function destroy() {
      this.game.tweens.remove(this._scaleIconTw);
      this.game.tweens.remove(this._shakeIconTw);
      _get(AbstractIndicator.prototype.__proto__ || Object.getPrototypeOf(AbstractIndicator.prototype), 'destroy', this).call(this);
    }
  }, {
    key: 'scaleIcon',
    value: function scaleIcon() {
      var _this2 = this;

      if (this._icon) {
        this._scaleIconTw = this.game.add.tween(this._icon.scale).from({ x: 0, y: 0 }, 300, Phaser.Easing.Sinusoidal.InOut, true);
        this._scaleIconTw.onComplete.add(function () {
          _this2.shakingIcon();
        });
        this._scaleIconTw.onStart.add(function () {
          _this2._icon.alpha = 1;
        });
    ...
    key: 'shakingIcon',
    value: function shakingIcon() {
      this._shakeIconTw = this.game.add.tween(this._icon).to({ angle: [0, -20, 20, -20, 20, 0] }, 1000, Phaser.Easing.Sinusoidal.InOut, true, 0, -1, true);
      this._shakeIconTw.repeatDelay(300);
      this._shakeIconTw.universal = true;
    }
  }, {
    key: '_buildIcon',
    value: function _buildIcon(config) {
      var x = config.x,
          y = config.y,
          scale = config.scale;

      var icon = (0, _utils.makeImage)((0, _imageConfigs.getPlayableIconConfig)());
    ...
    key: '_buildText',
    value: function _buildText(config) {
      var wordWrap = config.wordWrap,
          wordWrapWidth = config.wordWrapWidth,
          x = config.x,
          y = config.y,
          fontSize = config.fontSize;

      var text = (0, _utils.makeText)((0, _textConfigs.getIndicatorTextConfig)(wordWrap, wordWrapWidth, x, y, fontSize));
      text.anchor.set(0.5);
...
},{"../../configs/image-configs":139,"../../configs/text-configs":144,"../../utils":266,"../../utils/container":265}],240:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getIndicatorConfigByParams = getIndicatorConfigByParams;
...
function getIndicatorConfig() {
  return {
    //
    middle_icon_text: {
      bg: { type: _constants.IndicatorType.Round },
      icon: {
        x: 0,
        y: -15
      },
    ...
    //
    top_icon_text: {
      bg: { type: _constants.IndicatorType.Full },
      icon: {
        x: 0, // LP(-0.1, -0.14),
        y: 0,
        scale: 0.5
    ...
    //
    top_left_icon_text: {
      bg: { type: _constants.IndicatorType.RoundedRect },
      icon: {
        x: -200,
        y: 0.5,
        scale: 0.675
...
function getIndicatorConfigByParams(value) {
  var IndicatorConfig = getIndicatorConfig();
  return IndicatorConfig[value];
}

},{"../../constants":146}],241:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.IndicatorView = undefined;
...
var _indicatorConfig = require('./indicator-config');

var _rectIndicator = require('./rect-indicator');

var _roundIndicator = require('./round-indicator');

var _roundedRectIndicator = require('./rounded-rect-indicator');
...
var IndicatorView = exports.IndicatorView = function (_Phaser2Grid) {
  _inherits(IndicatorView, _Phaser2Grid);

  function IndicatorView() {
    _classCallCheck(this, IndicatorView);

    var _this = _possibleConstructorReturn(this, (IndicatorView.__proto__ || Object.getPrototypeOf(IndicatorView)).call(this, CI_API.game));

    _get(IndicatorView.prototype.__proto__ || Object.getPrototypeOf(IndicatorView.prototype), 'build', _this).call(_this, _this.getGridConfig());

    _this._build();
    return _this;
  }

  _createClass(IndicatorView, [{
    key: 'getGridConfig',
    value: function getGridConfig() {
      var type = CI_API.Globals.PARAMS.playable_indicator_type;

      return (0, _gridConfigs.getIndicatorGridConfig)(type);
    }
  }, {
    key: 'rebuild',
    value: function rebuild(config) {
      ...
      _get(IndicatorView.prototype.__proto__ || Object.getPrototypeOf(IndicatorView.prototype), 'rebuild', this).call(this, config);
    }
  }, {
    key: 'show',
    value: function show() {
      ...
      if (this._bgContainer) {
        var y = CI_API.Globals.PARAMS.playable_indicator_placement === 'bottom' ? (0, _utils.getGameBounds)().height + this._indicator.height * 2 : 0;

        this._showTw = this.game.add.tween(this._bgContainer).from({ y: y }, 300, Phaser.Easing.Sinusoidal.InOut, true);
      }
    }
  }, {
    key: 'hide',
    value: function hide(force) {
      ...
      var duration = force ? 10 : 450;
      this._indicator.hide(force);

      if (this._bgContainer) {
        var y = CI_API.Globals.PARAMS.playable_indicator_placement === 'bottom' ? (0, _utils.getGameBounds)().height + this._indicator.height * 2 : -this._indicator.height;

        this._hideTw = this.game.add.tween(this._bgContainer).to({ y: y }, duration, Phaser.Easing.Sinusoidal.InOut, true);
        this._hideTw.onComplete.add(function () {
          _this2._bgContainer.destroy();
        });
      }
    }
  }, {
    ...
    value: function _build() {
      var _CI_API$Globals$PARAM = CI_API.Globals.PARAMS,
          place = _CI_API$Globals$PARAM.playable_indicator_placement,
          type = _CI_API$Globals$PARAM.playable_indicator_type;

      var config = (0, _indicatorConfig.getIndicatorConfigByParams)(place + '_' + type);
      var bg = config.bg;


      switch (bg.type) {
        case _constants.IndicatorType.Full:
          {
            this._bgContainer = new _container.Container();
            var bgImage = (0, _utils.makeImage)((0, _imageConfigs.getIndicatorFrameTileConfig)());
            bgImage.scale.y = place === 'top' ? 1 : -1;
            this._bgContainer.addChild(bgImage);
            this.setChild(place + '_bg', this._bgContainer);
            this.setChild('' + place, this._indicator = new _rectIndicator.RectIndicator(config));
          }
          break;
        case _constants.IndicatorType.Round:
          this.setChild('' + place, this._indicator = new _roundIndicator.RoundIndicator(config));
          break;
        case _constants.IndicatorType.RoundedRect:
          this.setChild('' + place, this._indicator = new _roundedRectIndicator.RoundedRectIndicator(config));
          break;
...
},{"../../configs/grid-configs":123,"../../configs/image-configs":139,"../../constants":146,"../../utils":266,"../../utils/container":265,"./indicator-config":240,"./rect-indicator":242,"./round-indicator":243,"./rounded-rect-indicator":244,"@armathai/phaser2-grid":286}],242:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.RectIndicator = undefined;
...
var _abstractIndicator = require('./abstract-indicator');
...
var RectIndicator = exports.RectIndicator = function (_AbstractIndicator) {
  _inherits(RectIndicator, _AbstractIndicator);

  function RectIndicator(config) {
    _classCallCheck(this, RectIndicator);

    var _this = _possibleConstructorReturn(this, (RectIndicator.__proto__ || Object.getPrototypeOf(RectIndicator)).call(this));

    _this._build(config);
    return _this;
  }

  _createClass(RectIndicator, [{
    key: 'destroy',
    value: function destroy() {
      this.game.tweens.remove(this._showTw);
      this.game.tweens.remove(this._hideTw);
      _get(RectIndicator.prototype.__proto__ || Object.getPrototypeOf(RectIndicator.prototype), 'destroy', this).call(this);
    }
  }, {
    key: 'show',
    value: function show() {
      ...
      var y = CI_API.Globals.PARAMS.playable_indicator_placement === 'bottom' ? (0, _utils.getGameBounds)().height + this.height * 2 : 0;

      this._showTw = this.game.add.tween(this).from({ y: y }, 300, Phaser.Easing.Sinusoidal.InOut, true);

      this._showTw.onComplete.add(function () {
        _this2.scaleIcon();
      });
    }
  }, {
    ...
    value: function hide(force) {
      ...
      var duration = force ? 10 : 500;
      var y = CI_API.Globals.PARAMS.playable_indicator_placement === 'bottom' ? (0, _utils.getGameBounds)().height + this.height * 2 : -this.height;
      this._hideTw = this.game.add.tween(this).to({ y: y }, duration, Phaser.Easing.Sinusoidal.InOut, true);
      this._hideTw.onComplete.add(function () {
        _this3.destroy();
      });
    }
    ...
    key: '_position',
    value: function _position(icon, text) {
      if (icon && text) {
...
}(_abstractIndicator.AbstractIndicator);

},{"../../utils":266,"./abstract-indicator":239}],243:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.RoundIndicator = undefined;
...
var RoundIndicator = exports.RoundIndicator = function (_AbstractIndicator) {
  _inherits(RoundIndicator, _AbstractIndicator);

  function RoundIndicator(config) {
    _classCallCheck(this, RoundIndicator);

    var _this = _possibleConstructorReturn(this, (RoundIndicator.__proto__ || Object.getPrototypeOf(RoundIndicator)).call(this));

    _this._build(config);
    return _this;
  }

  _createClass(RoundIndicator, [{
    key: 'destroy',
    value: function destroy() {
      this.game.tweens.remove(this._showTw);
      this.game.tweens.remove(this._hideTw);
      this.game.tweens.remove(this._circleTw);
      _get(RoundIndicator.prototype.__proto__ || Object.getPrototypeOf(RoundIndicator.prototype), 'destroy', this).call(this);
    }
  }, {
    key: 'show',
    value: function show() {
    ...
    key: '_buildBg',
    value: function _buildBg() {
      var bg = (0, _utils.makeImage)((0, _imageConfigs.getIndicatorFrameCircleConfig)());
      this.addChild(this._bg = bg);
    }
  }, {
    key: '_buildCircle',
    value: function _buildCircle() {
      var circle = (0, _utils.makeImage)((0, _imageConfigs.getIndicatorLoadingCircleConfig)());
...
},{"../../configs/image-configs":139,"../../utils":266,"./abstract-indicator":239}],244:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.RoundedRectIndicator = undefined;
...
var RoundedRectIndicator = exports.RoundedRectIndicator = function (_AbstractIndicator) {
  _inherits(RoundedRectIndicator, _AbstractIndicator);

  function RoundedRectIndicator(config) {
    _classCallCheck(this, RoundedRectIndicator);

    var _this = _possibleConstructorReturn(this, (RoundedRectIndicator.__proto__ || Object.getPrototypeOf(RoundedRectIndicator)).call(this));

    _this._build(config);
    return _this;
  }

  _createClass(RoundedRectIndicator, [{
    key: 'destroy',
    value: function destroy() {
      this.game.tweens.remove(this._showTw);
      this.game.tweens.remove(this._hideTw);
      _get(RoundedRectIndicator.prototype.__proto__ || Object.getPrototypeOf(RoundedRectIndicator.prototype), 'destroy', this).call(this);
    }
  }, {
    key: 'show',
    value: function show() {
    ...
    key: '_buildRoundedRect',
    value: function _buildRoundedRect() {
      this.addChild(this._bg = this._buildRect());
    }
  }, {
    key: '_buildRect',
    value: function _buildRect() {
      var rect = (0, _utils.makeImage)((0, _imageConfigs.getIndicatorFrameRectangleConfig)());
      return rect;
    }
  }, {
    key: '_position',
  ...
  return RoundedRectIndicator;
}(_abstractIndicator.AbstractIndicator);

},{"../../configs/image-configs":139,"../../utils":266,"./abstract-indicator":239}],245:[function(require,module,exports){
'use strict';
...
},{"../configs/grid-configs":123,"../constants":146,"../events/model-events":151,"../events/view-events":152,"../utils":266,"./background/background-view":217,"./cta/cta-container":220,"./foreground/foreground-view":228,"./game/game-view":238,"./ui/ui-view":251,"@armathai/lego":281,"@armathai/phaser2-grid":286}],246:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.JoystickView = undefined;
...
var JoystickView = exports.JoystickView = function (_Container) {
  _inherits(JoystickView, _Container);

  function JoystickView() {
    _classCallCheck(this, JoystickView);

    var _this = _possibleConstructorReturn(this, (JoystickView.__proto__ || Object.getPrototypeOf(JoystickView)).call(this));
  ...
  _createClass(JoystickView, [{
    ...
    value: function enable() {
      ...
      this._bg.input.priorityID = _constants.InputPriority.Game + 1;
    ...
    key: '_onInputDown',
    value: function _onInputDown(target, pointer) {
      this._isPressed = true;
      this._pointer = pointer;

      _lego.lego.event.emit(_viewEvents.ViewEvents.JoystickView.Pressed);
    }
  }, {
    key: '_onInputUp',
    value: function _onInputUp(pointer) {
      if (pointer === this._pointer) {
        this._isPressed = false;
        this._pointer = null;

        _lego.lego.event.emit(_viewEvents.ViewEvents.JoystickView.Released);
      }
    }
  }, {
    key: '_build',
    ...
    value: function update() {
      if (this._isPressed) {
        ...
        var _pointer = this._pointer,
            pointerX = _pointer.x,
            pointerY = _pointer.y;

        var downPos = this.toLocal(new Phaser.Point(pointerX, pointerY), undefined);
        var downX = downPos.x,
            downY = downPos.y;

        var distance = Math.min(width / 2, Phaser.Math.distance(0, 0, downX, downY));

        var rad = Phaser.Math.angleBetweenPoints(new Phaser.Point(0, 0), new Phaser.Point(downX, downY));
        var x = Math.cos(rad) * distance;
        var y = Math.sin(rad) * distance;
      ...
      if (this._isPressed && status === _constants.AdStatus.Game && boardView && boardView.playerSnake) {
...
},{"../../constants":146,"../../events/model-events":151,"../../events/view-events":152,"../../models/store":215,"../../utils":266,"../../utils/container":265,"@armathai/lego":281}],247:[function(require,module,exports){
'use strict';
...
},{"../../configs/button-configs":122,"../../configs/particles-configs":142,"../../events/view-events":152,"../../utils":266,"../../utils/button/button":263,"../../utils/container":265,"@armathai/lego":281}],248:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.PointsComponent = undefined;
...
var PointsComponent = exports.PointsComponent = function (_Container) {
  _inherits(PointsComponent, _Container);

  function PointsComponent() {
    _classCallCheck(this, PointsComponent);

    var _this = _possibleConstructorReturn(this, (PointsComponent.__proto__ || Object.getPrototypeOf(PointsComponent)).call(this));
  ...
  _createClass(PointsComponent, [{
    ...
    key: '_buildPoints',
    value: function _buildPoints() {
      var points = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;

      this._text = (0, _utils.makeText)((0, _textConfigs.getPointsTextConfig)(points));
      this._text.anchor.set(0.5);
      (0, _utils.fitText)(this._text, 200, 100);
...
},{"../../configs/text-configs":144,"../../utils":266,"../../utils/container":265}],249:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.PowerUpView = undefined;
...
var PowerUpView = exports.PowerUpView = function (_Container) {
  _inherits(PowerUpView, _Container);

  function PowerUpView() {
    _classCallCheck(this, PowerUpView);

    var _this = _possibleConstructorReturn(this, (PowerUpView.__proto__ || Object.getPrototypeOf(PowerUpView)).call(this));
  ...
  _createClass(PowerUpView, [{
    ...
    key: '_enableHighlight',
    value: function _enableHighlight() {
      if (!this._showGlowTw) {
        this._showGlowTw = this.game.add.tween(this._glow).to({ alpha: 1 }, 1000, Phaser.Easing.Sinusoidal.InOut, true, 0, -1, true);
        this._showGlowTw.universal = true;
      }
    }
  }, {
    key: '_disableHighlight',
    value: function _disableHighlight() {
      var force = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;

      this._showGlowTw && this.game.tweens.remove(this._showGlowTw);
      this._showGlowTw && (this._showGlowTw = null);

      var duration = !force ? 1000 : 0;
      var tw = this.game.add.tween(this._glow).to({ alpha: 0 }, duration, Phaser.Easing.Sinusoidal.InOut, true, 0);
    ...
    value: function _onAdStatusUpdate(status) {
      ...
      var reason = _store.store.ad.cta.reason;
      var playerSnake = _store.store.game.boardModel.playerSnake;
      var ableToBoost = playerSnake.ableToBoost;


      switch (status) {
        case _constants.AdStatus.Cta:
          if (reason !== _constants.GameOverReasons.Failed && playerSnake && ableToBoost) {
            this._powerUp.alpha = 1;
            this._disableHighlight().onComplete.add(function () {
              _this2._enableHighlight();
            });
          } else {
            this._powerUp.alpha = 0.3;
    ...
    value: function _onInputDown() {
      if (this._isActive) {
        _lego.lego.event.emit(_viewEvents.ViewEvents.PowerUpView.Pressed);
    ...
    key: '_onInputOut',
    value: function _onInputOut() {
      this._powerUp.events.onInputOut.remove(this._onInputOut, this);
      this._powerUp.events.onInputUp.remove(this._onInputUp, this);
      _lego.lego.event.emit(_viewEvents.ViewEvents.PowerUpView.Released);
    }
  }, {
    key: '_onInputUp',
    ...
    key: '_buildPowerUp',
    value: function _buildPowerUp() {
      this._powerUp = (0, _utils.makeImage)((0, _imageConfigs.getPowerUpImageConfig)());
      this._powerUp.inputEnabled = true;
      this._powerUp.input.priorityID = _constants.InputPriority.Game + 1;
    ...
    value: function _buildGlow() {
      this._glow = (0, _utils.makeImage)((0, _imageConfigs.getPowerUpGlowImageConfig)());
...
},{"../../configs/image-configs":139,"../../constants":146,"../../events/model-events":151,"../../events/view-events":152,"../../models/store":215,"../../utils":266,"../../utils/container":265,"@armathai/lego":281}],250:[function(require,module,exports){
'use strict';
...
var TimerView = exports.TimerView = function (_Container) {
  ...
  function TimerView() {
    ...
    _this._build();
    _this._updateText(CI_API.Globals.PARAMS.game_timer);
    return _this;
  }
  ...
  _createClass(TimerView, [{
    ...
    value: function _updateText(value) {
      ...
      var text = parseInt(time.secondsStr, 10) >= 10 ? '0:' + parseInt(time.secondsStr, 10) : '0:0' + parseInt(time.secondsStr, 10);
    ...
    value: function _buildText() {
      this._text = (0, _index.makeText)((0, _textConfigs.getTimerTextConfig)());
      this._text.anchor.set(0.5);
      this.addChild(this._text);
    }
  }, {
...
},{"../../configs/text-configs":144,"../../events/model-events":151,"../../utils/container":265,"../../utils/index":266,"@armathai/lego":281}],251:[function(require,module,exports){
'use strict';
...
var _joystickView = require('./joystick-view');

var _persistentCtaView = require('./persistent-cta-view');

var _pointsComponent = require('./points-component');

var _powerUpView = require('./power-up-view');
...
var UIView = exports.UIView = function (_Phaser2Grid) {
  ...
  function UIView() {
    ...
    _lego.lego.event.on(_modelEvents.ModelEvents.AdModel.PersistentCtaUpdate, _this._onPersistentCtaUpdate, _this).on(_modelEvents.ModelEvents.AdModel.PowerUpUpdate, _this._onPowerUpUpdate, _this).on(_modelEvents.ModelEvents.PowerUpModel.StateUpdate, _this._onPowerUpStateUpdate, _this).on(_modelEvents.ModelEvents.AdModel.JoystickUpdate, _this._onJoystickUpdate, _this).on(_modelEvents.ModelEvents.JoystickModel.StateUpdate, _this._onJoystickStateUpdate, _this).on(_modelEvents.ModelEvents.PlayerModel.ScoreUpdate, _this._onPlayerScoreUpdate, _this).on(_modelEvents.ModelEvents.AdModel.StatusUpdate, _this._onAdStatusUpdate, _this);
    return _this;
  }
  ...
  _createClass(UIView, [{
    key: 'build',
    value: function build(config) {
      _get(UIView.prototype.__proto__ || Object.getPrototypeOf(UIView.prototype), 'build', this).call(this, config);
    ...
    key: '_rebuildJoystick',
    value: function _rebuildJoystick() {
    ...
    key: '_buildPlayerPoints',
    value: function _buildPlayerPoints() {
      this._points = new _pointsComponent.PointsComponent();
    ...
    key: '_onPlayerScoreUpdate',
    value: function _onPlayerScoreUpdate(newScore) {
    ...
    value: function _showPersistentCta() {
      ...
      this._showTw = (_LP = LP(_utils.showFromRight, _utils.showFromBottom)).call.apply(_LP, [null].concat(twArg));
      return this._showTw;
    }
  }, {
    ...
    value: function _hidePersistentCta() {
      ...
      this._hideTw = (_LP2 = LP(_utils.hideToRight, _utils.hideToBottom)).call.apply(_LP2, [null].concat(twArg));
      return this._hideTw;
    }
    ...
    key: '_onPowerUpUpdate',
    value: function _onPowerUpUpdate(powerUp) {
      var ctaType = CI_API.Globals.PARAMS.cta_type;
      ...
      } else if (!powerUp && ctaType === 'embedded' && _store.store.ad.cta.reason === _constants.GameOverReasons.Failed) {
        this._hidePowerUp().onComplete.add(this._destroyPowerUp, this);
      }
    }
  }, {
    key: '_onPowerUpStateUpdate',
    value: function _onPowerUpStateUpdate(state) {
      switch (state) {
        case _constants.PowerUpState.Enable:
          this._powerUp.enable();
          break;
        case _constants.PowerUpState.Disable:
    ...
    key: '_buildPowerUp',
    value: function _buildPowerUp() {
      this._powerUp = new _powerUpView.PowerUpView();
      this.setChild('power_up', this._powerUp);
    }
  }, {
    key: '_hidePowerUp',
    value: function _hidePowerUp() {
      var tw = this.game.add.tween(this._powerUp).to({ alpha: 0 }, 250, Phaser.Easing.Sinusoidal.InOut, true);
      tw.universal = true;
    ...
    key: '_destroyPowerUp',
    value: function _destroyPowerUp() {
      this._powerUp.destroy();
      this._powerUp = null;
    }
    ...
    key: '_onJoystickUpdate',
    value: function _onJoystickUpdate(joystick) {
      var ctaType = CI_API.Globals.PARAMS.cta_type;
      ...
      } else if (!joystick && ctaType === 'embedded' && _store.store.ad.cta.reason === _constants.GameOverReasons.Failed) {
        this._hideJoystick().onComplete.add(this._destroyJoystick, this);
      }
    }
  }, {
    ...
    value: function _onJoystickStateUpdate(state) {
      switch (state) {
        case _constants.JoystickState.Enable:
          ...
          break;
        case _constants.JoystickState.Disable:
          this._joystick.disable();
          break;
        default:
          break;
    ...
    key: '_buildJoystick',
    value: function _buildJoystick() {
      this._joystick = new _joystickView.JoystickView();
      this.setChild('joystick', this._joystick);
    }
  }, {
    key: '_hideJoystick',
    value: function _hideJoystick() {
      var tw = this.game.add.tween(this._joystick).to({ alpha: 0 }, 250, Phaser.Easing.Sinusoidal.InOut, true);
      tw.universal = true;
    ...
    key: '_showTimer',
    value: function _showTimer() {
      var twArg = [this._timerView, 0, 500, false, Phaser.Easing.Cubic.Out];
      var hideTw = _utils.showFromRight.apply(undefined, twArg);
      return hideTw;
    }
  }, {
    key: '_hideTimer',
    value: function _hideTimer() {
      var twArg = [this._timerView, 0, 500, false, Phaser.Easing.Cubic.In];
      var showTw = _utils.hideToRight.apply(undefined, twArg);
      return showTw;
    }
  }, {
    key: '_destroyTimer',
...
},{"../../configs/grid-configs":123,"../../constants":146,"../../events/model-events":151,"../../models/store":215,"../../utils":266,"./joystick-view":246,"./persistent-cta-view":247,"./points-component":248,"./power-up-view":249,"./timer-view":250,"@armathai/lego":281,"@armathai/phaser2-grid":286}],252:[function(require,module,exports){
'use strict';
...
},{"../constants":146,"../events/model-events":151,"../events/view-events":152,"../models/store":215,"@armathai/lego":281}],253:[function(require,module,exports){
'use strict';
...
function onFoodEat(data) {
  ...
  if (snake.isPlayer) {
    switch (type) {
      case _constants.FoodType.Regular:
        play('pallet-eat');
        break;
      case _constants.FoodType.Super:
...
function onPowerUpStateUpdate(state) {
  switch (state) {
    case _constants.PowerUpState.Pressed:
      play('button-tap');
      play('power-up', 1.5);
      break;
    case _constants.PowerUpState.Unknown:
    case _constants.PowerUpState.Disable:
    case _constants.PowerUpState.Enable:
      stop('power-up');
      break;
...
function onSnakeStateUpdate(state, prevState, uuid) {
  ...
  switch (state) {
    case _constants.SnakeState.Idle:
      snake.isPlayer && play('player-spawn');
      break;
    case _constants.SnakeState.Dead:
...
function SoundObservant() {
  ...
  _lego.lego.event.on(_modelEvents.ModelEvents.LoadModel.CompleteUpdate, onLoadCompleteUpdate, this).on(_modelEvents.ModelEvents.AdModel.StatusUpdate, onAdStatusUpdate, this).on(_modelEvents.ModelEvents.PowerUpModel.StateUpdate, onPowerUpStateUpdate, this).on(_modelEvents.ModelEvents.JoystickModel.StateUpdate, onJoystickStateUpdate, this).on(_modelEvents.ModelEvents.SnakeModel.StateUpdate, onSnakeStateUpdate, this).on(_viewEvents.ViewEvents.BoardView.SnakeEatFood, onFoodEat, this).on(_viewEvents.ViewEvents.PersistentCtaView.Click, onButtonClick, this).on(_viewEvents.ViewEvents.CtaView.PlayClick, onButtonClick, this).on(_viewEvents.ViewEvents.CtaView.RetryClick, onButtonClick, this);
}

},{"../constants":146,"../events/model-events":151,"../events/view-events":152,"../models/store":215,"@armathai/lego":281}],254:[function(require,module,exports){
'use strict';
...
},{"../constants":146,"../events/model-events":151,"../events/view-events":152,"../models/store":215,"@armathai/lego":281}],255:[function(require,module,exports){
'use strict';
...
var GameState = exports.GameState = function (_Phaser$State) {
  ...
  _createClass(GameState, [{
    ...
    value: function render() {
      ...
      var boardView = (0, _utils.getViewByProperty)('name', 'BoardView');
      if (boardView) {
        boardView.snakes.forEach(function (s) {
          if (s && s.parts) {
            s.parts.forEach(function (p) {
              _this2.game.debug.geom(p.collisionBody, 'rgba(255,0,0,0.8)', true, 2);
            });
          }
        });
      }
    ...
    value: function update() {
      ...
      if (ad_state === 'live' && this._adModel.status !== _constants.AdStatus.Cta) {
        if (game.time.totalElapsedSeconds() - Globals.LAST_INTERACTION_TIME > Globals.PARAMS.cta_on_idle_time * 0.001) {
          if (CI_API.Globals.PARAMS.joystick_enabled) {
            var joystickView = (0, _utils.getViewByProperty)('name', 'JoystickView');
            joystickView && !joystickView.pointer && _lego.lego.event.emit(_viewEvents.ViewEvents.GameState.CtaIdleTime);
          } else {
            var gameView = (0, _utils.getViewByProperty)('name', 'GameView');
            gameView && !gameView.pointer && _lego.lego.event.emit(_viewEvents.ViewEvents.GameState.CtaIdleTime);
          }
        }
      }
    }
...
},{"../constants":146,"../events/view-events":152,"../models/store":215,"../objects/main-view":245,"../utils":266,"@armathai/lego":281}],256:[function(require,module,exports){
'use strict';
...
var PreloaderState = exports.PreloaderState = function (_Phaser$State) {
  ...
  _createClass(PreloaderState, [{
    ...
    value: function preload() {
       ...
       */
      xp.loadAssets({
        spine: ['snakes' // Spine name can be set as the string
...
},{"../display/layout-utils":148,"../events/view-events":152,"../kernel/atlas-rescale":191,"../kernel/multiple-atlas":193,"../models/store":215,"@armathai/lego":281}],257:[function(require,module,exports){
'use strict';
...
},{"../number/random-int":267}],262:[function(require,module,exports){
'use strict';
...
},{"./input-handler":264}],263:[function(require,module,exports){
'use strict';
  ...
  _createClass(Button, [{
    ...
    value: function createState(config) {
      ...
      var bg = config.bg,
          ...
          fitWidth = _config$fitWidth === undefined ? 0.8 : _config$fitWidth,
          _config$fitHeight = config.fitHeight,
          fitHeight = _config$fitHeight === undefined ? 0.8 : _config$fitHeight;
...
},{"..":266,"./abstract-button":262}],264:[function(require,module,exports){
'use strict';
...
},{"@armathai/lego":281,"@armathai/phaser2-grid":286}],266:[function(require,module,exports){
'use strict';
...
},{"./object/object-keys":269,"./tween/universal-tween":270}],267:[function(require,module,exports){
"use strict";
...
},{"./Types":272,"./utils/Utils":274,"./utils/geom/Point":275,"./utils/geom/Rect":276}],272:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var CellScale;
(function (CellScale) {
...
},{"./Cell":271,"./Types":272,"./utils/Utils":274,"./utils/geom/Point":275,"./utils/geom/Rect":276}],274:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Types_1 = require("../Types");
...
},{"../Types":272,"./geom/Point":275,"./geom/Rect":276}],275:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
...
},{"./index":281}],278:[function(require,module,exports){
"use strict";
var __read = (this && this.__read) || function (o, n) {
    var m = typeof Symbol === "function" && o[Symbol.iterator];
    if (!m) return o;
...
},{"./utils/Map":282}],279:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Command":277,"./Emitter":278,"./Observe":280}],280:[function(require,module,exports){
"use strict";
var __values = (this && this.__values) || function(o) {
    var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
    if (m) return m.call(o);
...
},{"./index":281}],281:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Lego":279,"./utils/Utils":283}],282:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Debugger":284,"@armathai/grid-core":273}],286:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var grid_core_1 = require("@armathai/grid-core");
...
},{"./Phaser2Grid":285,"@armathai/grid-core":273}],287:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"./NinePatch":287}],289:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var NinePatch_1 = require("./NinePatch");
...
},{"./NinePatch":287,"./NinePatchPlugin":288}],290:[function(require,module,exports){
